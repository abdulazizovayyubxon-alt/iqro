...
const s = {
  ...
  title: { fontSize: 'var(--fs-2xl)', fontWeight: 700, margin: 0, textAlign: 'center' },
  ...
  lead: { fontSize: 'var(--fs-3xl)', fontWeight: 800, textAlign: 'center', margin: '0 0 12px', color: 'var(--text)' },
  heading: { fontSize: 'var(--fs-2xl)', fontWeight: 700, marginTop: 28, marginBottom: 14, color: 'var(--text)' },
  text: { fontSize: 'var(--fs-lg)', color: 'var(--text2)', marginBottom: 16 },
  ...
  cardTitle: { fontSize: 'var(--fs-lg)', fontWeight: 700, color: 'var(--text)', marginBottom: 3 },
  cardDesc: { fontSize: 'var(--fs-md)', color: 'var(--text3)', lineHeight: 1.5 },
  contactBtn: {
  ...
  footerNote: { textAlign: 'center', fontSize: 'var(--fs-sm)', color: 'var(--text3)', marginTop: 28 },
};
