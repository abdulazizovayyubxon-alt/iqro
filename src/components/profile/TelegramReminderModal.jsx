  ...
  return (
    <ModalShell onClose={onClose} maxWidth={440} style={{ padding: '24px' }}>
      <div className="pp-modal-title" style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: '20px' }}>
        <Send size={22} style={{ color: 'var(--accent)' }} /> Telegram Sozlamalari
      </div>
      ...
      <div style={{ background: 'var(--bg3)', borderRadius: 16, padding: '16px', marginBottom: 16, border: '1px solid var(--border)' }}>
        ...
        <div style={{ fontSize: 12, color: 'var(--text3)', lineHeight: 1.5 }}>
          Har kuni test ishlash eslatmalarini Telegram bot orqali oling. Buning uchun <a href="tg://resolve?domain=IQRO_testbot" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 700 }}>@IQRO_testbot</a> botiga <code style={{ background: 'var(--bg)', padding: '2px 4px', borderRadius: 4 }}>{telegramCode}</code> kodini yuboring.
        </div>
      </div>
