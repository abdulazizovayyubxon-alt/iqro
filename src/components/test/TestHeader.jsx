    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, paddingBottom: 12, borderBottom: '1px solid #F1F5F9', marginBottom: 12 }}>
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        <button
          ...
          style={{ background: mode === 'flashcard' ? 'var(--accent)' : 'var(--bg3)', border: 'none', borderRadius: 10, color: mode === 'flashcard' ? '#fff' : 'var(--text3)', cursor: 'pointer', padding: '8px 12px', display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, fontWeight: 700, fontFamily: 'inherit' }}
        >
          <Zap size={15} />
        ...
        <button
          ...
          style={{ background: 'var(--bg3)', border: 'none', borderRadius: 10, color: 'var(--text3)', cursor: 'pointer', padding: 8, display: 'flex', alignItems: 'center' }}
        >
          <RefreshCw size={17} />
        </button>
      </div>
