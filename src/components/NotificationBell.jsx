            ...
            <div className="notif-list">
              {notifications.length === 0 ? (
                ...
                notifications.map((n) => (
                  ...
                  >
                    <div className={`notif-icon-box ${n.type === 'achievement' || n.type === 'unvon' || n.type === 'milestone' ? 'success' : n.type}`}>
                      {n.type === 'unvon' ? <BadgeCheck size={18} /> : n.type === 'achievement' ? <Award size={18} /> : n.type === 'milestone' ? <Flag size={18} /> : n.type === 'success' ? <CheckCircle2 size={18} /> : n.type === 'warning' ? <AlertCircle size={18} /> : <Info size={18} />}
                    </div>
