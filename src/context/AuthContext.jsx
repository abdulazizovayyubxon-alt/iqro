...
export const AuthProvider = ({ children }) => {
  ...
  // ────────────────────────────────────────────────────────
  // SMS OTP (Cynox.uz) — raqamni tasdiqlab kirish/ro'yxatdan o'tish
  // Parol o'rniga: foydalanuvchi telefoniga yuborilgan 6 xonali kodni kiritadi.
  ...
  const sendOtp = async (phone) => {
    ...
    if (import.meta.env.DEV) {
      await new Promise(r => setTimeout(r, 600));
      return { success: true, isNew: !cleanPhone.includes('77'), cooldown: 120, devCode: '111111' };
    }
