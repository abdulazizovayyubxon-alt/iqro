export const q1_umumharbiy_nizomlar = [
  {
      "q": "Daryo flotida (kichik zobitlar) bitta vertikal ko'rinishida yulduzi bo'lmagan, lekin pagonda bitta ingichka chiziq o'tgan bo'lsa, u qanday unvon?",
      "opts": [
        "A) Matros",
        "B) Katta matros",
        "C) 2-darajali starshina",
        "D) Michman"
      ],
      "correct": 2,
      "explanation": "Kichik yulduzlarsiz chiziqchali formalar serjant/starshinalarga xos bo'lib aynan ingichka chiziqchalar starshina pagonlariga belgidir.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Muddatli harbiy xizmatni o'tayotgan oddiy askarlar, fuqarolarga nisbatan huquqiy jihatdan qanday maqomda bo'ladilar?",
      "opts": [
        "A) Ularning huquqlari umuman yo'q",
        "B) Ular davlat himoyasidagi O'zbekiston Respublikasi harbiy xizmatchilari va to'laqonli fuqarolar maqomidadir",
        "C) Ular faqat Mudofaa vazirligiga qarashli tovar sifatida qabul qilinadi",
        "D) Ularga Konstitutsiya ta'sir qilmaydi"
      ],
      "correct": 1,
      "explanation": "Harbiy xizmatchi qasamyod qabul qilish barobarida fuqarolik huquqlaridan mahrum bo'lmaydi, aksincha u davlat ko'krak nishoni va imtiyozli maqomiga ega bo'lgan shaxsdir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy xizmatchi harbiy qasamyodni qachon va qanday sharoitda qabul qiladi?",
      "opts": [
        "A) Harbiy qismga kelishi bilan xonasida indamay",
        "B) Tinchlik davrida 2 oy ichida Dastlabki harbiy tayyorgarlik kursi(karantin)dan so'ng, qism jangovar bayrog'i ostida ochiq marosimda",
        "C) Faqat xizmatning so'nggi kunida shon-sharaf uchun",
        "D) Komandir xonasiga kirib yolg'iz qasamyod yozadi"
      ],
      "correct": 1,
      "explanation": "Qasamyod maxsus o'quv(karantin) kursidan o'tgan yosh askarlarga tantanali ravishda Davlat bayrog'i va qism ruxsati ostida ommaviy tartibda qabul qilinadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "O'zbekiston Respublikasi fuqarolarining harbiy xizmatni o'tash muddatlari (muddatli harbiy xizmat) qancha qilib belgilangan?",
      "opts": [
        "A) 24 oy",
        "B) 18 oy",
        "C) 12 oy",
      ...
      "correct": 2,
      "explanation": "Qonunchilikka ko'ra, oddiy askar tarkibidagi harbiy xizmatchilar uchun muddatli harbiy xizmat 12 oyni (1 yil) tashkil etadi.",
      "mnemonic": "Bir yil = 12 oy = Muddatli xizmat muddati."
    },
  {
      "q": "Harbiy qasamyod qachon qabul qilinadi va u nimani anglatadi?",
      "opts": [
        "A) Xizmat tugagandan so'ng, faxr belgisi sifatida",
        "B) Boshlang'ich tayyorgarlikdan so'ng, Vatanga sadoqat, buyruqlarga so'zsiz bo'ysunish va el-yurtni himoya qilishga tantanali va'da sifatida",
        "C) Xizmatga chaqirilishidan oldin",
        "D) Urush boshlanganda"
      ],
      "correct": 1,
      "explanation": "Harbiy qasamyod xizmat boshidagi muqaddas burch bo'lib, askarga yuridik javobgarlik yuklovchi qasamyoddir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Muddatli harbiy xizmatchilarga qanday ta'til berilishi mumkin?",
      "opts": [
        "A) Oila qurish uchun 1 oylik",
        "B) Xizmatdagi a'lo ko'rsatkichlari uchun 10 kungacha rag'batlantirish ta'tili",
        "C) Istagan vaqtda 3 kunlik",
        "D) Muddatli xizmatda ta'til yo'q"
      ],
      "correct": 1,
      "explanation": "Oddiy askarlarga zo'r xizmati uchun komandir tomonidan ota-onasi yoniga borib kelish u-n 10 kungacha ta'til beriladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy qasamyod – bu nima?",
      "opts": [
        "A) Askarning shaxsiy va'dasi",
        "B) Diniy qasamyod",
        "C) Vatan va xalq oldida davlat manfaatlarini himoya qilish uchun beriladigan tantanali va yuridik majburiyat",
        "D) Oliy Bosh Qo'mondonga shaxsiy sadoqat izhori"
      ],
      "correct": 2,
      "explanation": "Harbiy qasamyod yuridik kuchga ega bo'lgan tantanali majburiyat bo'lib, uni qabul qilish orqali askar Vatan oldida o'z mas'uliyatini tasdiqlaydi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy qasamyod qachon qabul qilinadi?",
      "opts": [
        "Harbiy xizmatga chaqirilganda",
        "Boshlang'ich harbiy tayyorgarlikdan so'ng",
        "Xizmat tugashidan oldin",
        "Urush boshlanganda"
      ],
      "correct": 1,
      "explanation": "Yangi chaqirilgan askarlar 'Genereat' (kursantlar tayyorgarligi) bosqichini o'tagach, tantanali ravishda qasamyod qiladilar.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qaysi toifadagi harbiy xizmatchilar gauptvaxtada mutlaqo alohida saqlanishi shart?",
      "opts": [
        "A) Muddatli harbiy xizmatchilar va kontrakt bo‘yicha xizmat qilayotgan oddiy askar va serjantlar.",
        "B) Ofitserlar tarkibi muddatli va kontrakt bo‘yicha oddiy askar hamda serjantlardan alohida saqlanadi.",
        "C) Harbiy oliy bilim yurti kursantlari va muddatli harbiy xizmatchilar alohida xonalarda.",
        "D) Birinchi marta jazo olayotganlar va ilgari sudlangan harbiy xizmatchilar alohida."
      ],
      "correct": 1,
      "explanation": "Ofitserlar tarkibi muddatli va kontrakt bo‘yicha oddiy askar hamda serjantlardan alohida saqlanishi shart.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "(10-modda) Harbiy lavozimlar tarkibiy jihatdan qanday guruhlarga bo‘linadi?",
      "opts": [
        "A) Boshqaruvchi lavozimlar, ijrochi lavozimlar va texnik xizmat ko‘rsatuvchi lavozimlarga.",
        "B) Markaziy boshqaruv lavozimlari va hududiy harbiy bo‘linmalar lavozimlariga.",
        "C) Oddiy askarlar, serjantlar va ofitserlar tarkibi lavozimlariga bo‘linadi.",
        "D) Doimiy shaylikdagi lavozimlar va rezerv uchun mo‘ljallangan vaqtincha shtatlarga."
      ],
      "correct": 2,
      "explanation": "Harbiy lavozimlar tarkibiy jihatdan oddiy askarlar, serjantlar va ofitserlar tarkibi lavozimlariga bo‘linadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "(9-modda) Harbiy xizmatchilar va harbiy xizmatga majburlar tarkibiy jihatdan qanday bo‘linadi?",
      "opts": [
        "A) oddiy askarlar va boshqaruvchi ofitserlar tarkibiga.",
        "B) Kichik mutaxassislar, o‘rta bo‘g‘in komandirlari va yuqori qo‘mondonlik tarkibiga.",
        "C) Oddiy askarlar, serjantlar va ofitserlar tarkibiga bo‘linadi.",
        "D) Muddatli harbiy xizmatchilar, kontraktniklar va rezervdagi ofitserlar tarkibiga."
      ],
      "correct": 2,
      "explanation": "Harbiy xizmatchilar va majburlar oddiy askarlar, serjantlar va ofitserlar tarkibiga bo‘linadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Oddiy askarlar tarkibi\"ga kiruvchi unvonlar to‘g‘ri ko‘rsatilgan javobni toping.",
      "opts": [
        "A) Oddiy askar va starshina",
        "B) Oddiy askar va matros",
        "C) Oddiy askar va kichik serjant",
        "D) Matros va serjant"
      ],
      "correct": 1,
      "explanation": "Oddiy askarlar tarkibiga \"oddiy askar\" va \"matros\" unvonlari kiradi.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Oddiy askarlar va serjantlar uchun 2-darajali rezervning chegara yoshi necha yosh?",
      "opts": [
        "A) 35 yoshgacha",
        "B) 40 yoshgacha",
        "C) 45 yoshgacha",
      ...
      "correct": 2,
      "explanation": "Oddiy askarlar va serjantlar uchun 2-darajali rezervning chegara yoshi 45 yoshgacha hisoblanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "26-modda. Kontrakt bo‘yicha xizmat o‘tayotgan oddiy askarlar, serjantlar va kichik ofitserlar uchun harbiy xizmatda bo‘lishning yosh chegarasi necha?",
      "opts": [
        "A) Oltmish yosh",
        "B) Ellik yosh",
        "C) Qirq besh yosh",
      ...
      "correct": 1,
      "explanation": "Kontrakt bo‘yicha xizmat o‘tayotgan oddiy askarlar, serjantlar va kichik ofitserlar uchun yosh chegarasi 50 yosh qilib belgilangan.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qaysi harbiy tarkib uchun 2-darajali rezerv yoshi 45 yoshgacha qilib belgilangan?",
      "opts": [
        "A) Oddiy askarlar va serjantlar",
        "B) Kichik ofitserlar",
        "C) Katta ofitserlar",
        "D) Generallar"
      ],
      "correct": 0,
      "explanation": "Oddiy askarlar va serjantlar tarkibi uchun 2-darajali rezerv yoshi 45 yoshgacha qilib belgilangan.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "24-modda). Kontrakt bo‘yicha harbiy xizmatga kiruvchi oddiy askarlar va serjantlar uchun yosh chegarasi qanday?",
      "opts": [
        "A) o‘n sakkiz yoshdan yigirma besh yoshgacha bo‘lgan fuqarolar qabul qilinadi.",
        "B) O‘ttiz yoshgacha bo‘lgan harbiy xizmatga majburlar va ayollar.",
        "C) Qirq besh yoshgacha bo‘lgan va oliy ma’lumotga ega barcha xohlovchi fuqarolar.",
        "D) muddatli harbiy xizmatni o‘tagan va yoshi yigirma yetti yoshdan oshmaganlar."
      ],
      "correct": 1,
      "explanation": "Kontrakt bo‘yicha xizmatga kiruvchi oddiy askarlar va serjantlar uchun yosh chegarasi 30 yosh etib belgilangan.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning 'Sutkalik Naryadga' tayinlanishi, unga dam olinishi bo'yicha necha soatlik muddatni yopiq va ruhan og'ir xizmat deya tutilishi deyiladi?",
      "opts": [
        "A) 8 Soatlik ish smenasi",
        "B) To'la qonli 24 Soat (Sutka), biroq o'rtada belgilangan yopiq navbatchilik asosida dam olish oraliqlari asnosida",
        "C) 12 soat yopiq",
        "D) Butunlay 48 soat qamalish"
      ],
      "correct": 1,
      "explanation": "Sutkalik naryad bu yengil ish emas, tana va ruh tayyorgarligi tekshiriladigan 24 soatlik to'liq harakatdagi kechayu kunduz javobgarlik bo'lib - haqiqiy askarni o'stiradi.",
      "mnemonic": "Sakkiz (8) soat uyqu - askar uchun baxt."
    },
  {
      "q": "Harbiy askar ovqatlangach yoki formadagi qoidaga zid ifloslanganda asosan qanday jazolash/yoxun tarbiya ko'rinishiga tez tushadi?",
      "opts": [
        "A) Ovqatsiz qo'yish",
        "B) Urish qattiq",
        "C) Eng ko'p ishlatidigan jazo bu naryad navbatdan tashqari obiyekt tozalagiga chaqirilisa yohud poyafzal/hojatxona tozlash malakasiga oylshga jalib xam buladi (agar avtoridat bosa)",
        "D) Hich nsras bomasdi"
      ],
      "correct": 2,
      "explanation": "Axloq va tartibsizik qiyofasia asosan dnyovaliniylik ya'ni mehnabiy jiyisimi ozizni shxis giegenaga urgatdiishga jzolanid.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarga berilngan 2 sutkalig hibs-kamerada(arrestda) u qanday shraoito'ta doimiy bo'ladu?",
      "opts": [
        "A) Teledivorli uyda",
        "B) Poldan tashqi narsa bo'lmagan qatiy va sovuq xujerada kunduzgi damni(utirish va chuzilishgchiya ruxssatsiiz) izalyatyodaa olib broildi (Kitob va jismoniy ruxstsizi xolos)",
        "C) Osionda doim kzyimda",
        "D) Fqaqat ovqat edyq"
      ],
      "correct": 1,
      "explanation": "Kamerada gaplahsiz shihy qatix va ovqtyni ykisiimini cheklahs b-n 24 sqoti oytriish ruxstitiis faqat tuirgaziib uz xaosiyini pisyxilogig uylahsyigga mijibur quishidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning xizmat joyini ruxsatsiz (o'zboshimchalik bilan) tashlab ketishi qanday javobgarlikka olib keladi?",
      "opts": [
        "A) Oddiy tanbeh",
        "B) Hech qanday",
        "C) Intizomiy va hatto jinoyat (Harbiy tribunal) javobgarligiga tortiladi",
        "D) Mukofotdan quruq qolish"
      ],
      "correct": 2,
      "explanation": "Samovolka (qismni ruxsatsiz tashlash) bu vatanga xiyonatga tenglashtirilib, xizmatdan qochish deya jinoyat ishi qo'zg'atiladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qorovul xizmatiga qo'yilgan asgarlar navbatchilik oldidan qanday joyda tayyorgarlik ko'rishadi?",
      "opts": [
        "A) Oshxonada",
        "B) Maxsus Qorovullik shaharchasida (Qorovulxona tayyorgarlik maydonida) barcha ehtimoliy hujumlarni mashq qilib ko'rishadi",
        "C) Uyda",
        "D) Sport maydonida"
      ],
      "correct": 1,
      "explanation": "Qorovulga chiqish bu oddiy ish emas, shu sababli askarlar maxsus stendlar oldida parolni va postga dushman bostirib kirganda harakatini mashq qilishadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Kechki tekshiruv (Vechernyaya poverka) rotada nima uchun o'tkaziladi?",
      "opts": [
        "A) Kiyimlarni yuvish uchun",
        "B) Faqat yangiliklarni eshitish uchun",
        "C) Har kun kechqurun shaxsiy tarkibning ro'yxat bo'yicha joydaligi, qochib ketmaganligi va sog'lig'ini tekshirish uchun o'tkaziladi",
        "D) Qoshiqlarni sanash uchun"
      ],
      "correct": 2,
      "explanation": "Kechqurun uxlashdan oldin barcha askarlar saflanadi, ism-familiyalar o'qiladi va barcha joyidaligiga (qismda to'liqligiga) ishonch hosil qilinadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "24-modda. Kontrakt bo‘yicha harbiy xizmatga kirishda oliy ma’lumotli fuqarolar qaysi lavozimlar tarkibiga qabul qilinishi belgilangan?",
      "opts": [
        "A) oliy harbiy ta’lim muassasalarining kursantlari lavozimlariga",
        "B) Faqat oddiy askarlar va serjantlar tarkibidagi lavozimlarga",
        "C) Muddatli harbiy xizmatni o‘tagan, o‘ttiz yoshgacha bo‘lgan fuqarolar — oddiy askarlar, serjantlar va ofitserlar tarkibi lavozimlariga",
        "D) Qirq yoshgacha bo‘lgan, muqaddam kontrakt bo‘yicha xizmat o‘tagan barcha fuqarolar — faqat generallar tarkibi lavozimlariga"
      ],
      "correct": 2,
      "explanation": "Muddatli harbiy xizmatni o‘tagan, o‘ttiz yoshgacha bo‘lgan fuqarolar — oddiy askarlar, serjantlar va ofitserlar tarkibi lavozimlariga qabul qilinadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "O'q uzilishida stvol (nay)(nay)dan chiqadigan olov qanday vizual kamchilikka ega?",
      "opts": [
        "A) Otuvchini isitadi",
        "B) Tunda otuvchining o'zini ko'r qilib qo'yadi va dushmanga uning aniq joylashuvini fosh qiladi",
        "C) Nishonni yoritadi",
        "D) Qiziqarli effekt beradi"
      ],
      "correct": 1,
      "explanation": "Olov va chaqnash snayper va askarlarning dushman nazariga tushib qolishidagi birinchi omildir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "O't ochish pozitsiyasini tanlashda birinchi navbatda nima e'tiborga olinadi?",
      "opts": [
        "A) Quyoshning joylashuvi",
        "B) Qulay ko'rish, otish va dushman o'tidan xavfsiz himoyalanish imkoniyati",
        "C) Tuproqning yumshoqligi",
        "D) Manzaraning chiroyliligi"
      ],
      "correct": 1,
      "explanation": "To'g'ri pozitsiya askarga nishonni yaxshi ko'rish va o'zini o'qdan pana qilish imkonini berishi shart.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 0.5 bo‘lsa, masofa qancha?",
      "opts": [
        "3600 metr",
        "3800 metr",
        "3400 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 0.5 = 3600 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 0.6 bo‘lsa, masofa qancha?",
      "opts": [
        "3000 metr",
        "3200 metr",
        "2800 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 0.6 = 3000 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 0.9 bo‘lsa, masofa qancha?",
      "opts": [
        "2000 metr",
        "2200 metr",
        "1800 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 0.9 = 2000 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 1.0 bo‘lsa, masofa qancha?",
      "opts": [
        "1800 metr",
        "2000 metr",
        "1600 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 1.0 = 1800 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 1.2 bo‘lsa, masofa qancha?",
      "opts": [
        "1500 metr",
        "1700 metr",
        "1300 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 1.2 = 1500 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "PKM masofasi: Bir yarim (1.5) kilometr."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 1.5 bo‘lsa, masofa qancha?",
      "opts": [
        "1200 metr",
        "1400 metr",
        "1000 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 1.5 = 1200 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 1.8 bo‘lsa, masofa qancha?",
      "opts": [
        "1000 metr",
        "1200 metr",
        "800 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 1.8 = 1000 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 2.0 bo‘lsa, masofa qancha?",
      "opts": [
        "900 metr",
        "1100 metr",
        "700 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 2.0 = 900 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 3.0 bo‘lsa, masofa qancha?",
      "opts": [
        "600 metr",
        "800 metr",
        "400 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 3.0 = 600 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askarning bo‘yi orqali masofani aniqlash (1.8 : 1000 formula bo‘yicha): Agar natija 4.5 bo‘lsa, masofa qancha?",
      "opts": [
        "400 metr",
        "600 metr",
        "200 metr",
      ...
      "correct": 0,
      "explanation": "Formula: (1.8 * 1000) / 4.5 = 400 metr. Merganlik formulasining asosi hisoblanadi.",
      "mnemonic": "F-1 (Formula 1) tezligi 200+ bo'lganidek, radiusi ham 200m."
    },
  {
      "q": "Askar kuzatishni va niyshonni izlashni qanday hudud tartibi bo'yicha amalga oshirishi talab qilinadi?",
      "opts": [
        "A) Uzoqdan yaqin frontga qarab (orqadan oldinga)",
        "B) O'z yaqinidan boshlab to uzoqqa qarab (o'ngdan chapga, tizimli sektori bo'ylab)",
        "C) Ixtiyoriy qayeri xolasa, u yerdan qarayverish",
        "D) Faqat osmonga qarab"
      ],
      "correct": 1,
      "explanation": "Kuzatish qoidalarga tayanib askar avvalo o'zining eng yaqin hududini o'ng tomondan chapga sektormi-sektor skaner qilib oborilishiy lozim.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Jang paytida yakkalanib qolgan askar nima qilishi kerak?",
      "opts": [
        "A) Taslim bo'lishi",
        "B) Asabni ushlab, dushman ko'zidan panada manevr qilgan holda tezroq o'z guruhini yoki o'z qo'shinlari tomonini (kompas bo'yicha) topib qo'shilishi",
        "C) Yig'lashi",
        "D) Uxlagani yotishi"
      ],
      "correct": 1,
      "explanation": "Askar yolg'iz qolganda ham ruhiy barqarorlikni saqlab, yashirin holatda o'z qismini izlash marshrutini tuzadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Kuzatuvchi askarning vazifasi nimadan iborat?",
      "opts": [
        "A) Faqat atrofni tomosha qilish",
        "B) Dushmanning harakatlarini yashirincha doimiy kuzatib, barcha o'zgarishlar haqida komandirga o'z vaqtida doklad (axborot) qilish",
        "C) O'qotar qurolidan tinimsiz o't ochish",
        "D) Oziq-ovqat tayyorlash"
      ],
      "correct": 1,
      "explanation": "Kuzatuvchi mudofaada yoki postda o'ta diqqatli bo'lishi va dushman razvedkasi yoki hujumi alomatlarini birinchi bo'lib aniqlashi shart.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Kompasi bo'lmagan askar tunda yo'nalishni qanday aniqlashi mumkin?",
      "opts": [
        "A) Ovoz orqali",
        "B) Shamol yo'nalishi orqali",
        "C) Qutb yulduzi yordamida (u doimo Shimolni ko'rsatadi)",
        "D) Daryoga qarab"
      ],
      "correct": 2,
      "explanation": "Katta ayiq yulduz turkumi orqali Qutb yulduzini topish tungi orientatsiyaning eng ishonchli usulidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Topografik masalalar tahlili Askar kunduzi o'rmonda kompassiz qolib ketdi. U daraxtlarning qobig'i va shoxlariga qarab shimol yo'nalishini aniqlamoqchi. Quyidagi belgilardan qaysi biri MANTIQAN XATO hisoblanadi?",
      "opts": [
  ...
  {
      "q": "\"I darajali serjant\" unvonining kema tarkibidagi muqobili qaysi?",
      "opts": [
        "A) I darajali starshina",
        "B) II darajali starshina",
        "C) I darajali starshina",
        "D) Bosh starshina"
      ],
      "correct": 0,
      "explanation": "I darajali serjant unvonining kema tarkibidagi muqobili I darajali starshinadir.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Kema tarkibidagi serjantlar ierarxiyasida \"II darajali starshina\" qaysi unvonlar orasida joylashgan?",
      "opts": [
        "A) Starshina va III darajali starshina",
        "B) I darajali starshina va bosh starshina",
        "C) III darajali starshina va I darajali starshina",
        "D) Bosh starshina va matros"
      ],
      "correct": 2,
      "explanation": "Kema tarkibidagi serjantlar ierarxiyasida II darajali starshina III darajali starshina va I darajali starshina unvonlari orasida joylashgan.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Qo‘shin unvonlaridagi \"katta serjant\" unvoniga kema tarkibidagi qaysi unvon muvofiq keladi?",
      "opts": [
        "A) I darajali starshina",
        "B) Bosh starshina",
        "C) III darajali starshina",
        "D) I darajali starshina"
      ],
      "correct": 1,
      "explanation": "Katta serjant unvoniga kema tarkibidagi bosh starshina unvoni muvofiq keladi.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Harbiy xizmatchilarga buyruq kim tomonidan qanday tartibda beriladi?",
      "opts": [
        "A) Yozma shaklda tushuntirilish orqali",
        "B) Aniq, tushunarli, aniq muddat bilan tartibdagi bevosita komandir tomonidan yakka tarzda",
        "C) Ixtiyoriy ravishda kim bo'sh bo'lsa",
        "D) Buyruqni muhokama qilishiga ruxsat qilingan holatda"
      ],
      "correct": 1,
      "explanation": "Harbiy buyruq qat'iy va hech qanaqa muhokamalarsiz darrov yoki qattiq belgilangan muddatda bajarish hissi bilan shaxsan beriladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Soqchiga postda turganda shubhali shaxsga nisbatan qanday tartibda ogohlantirish beriladi?",
      "opts": [
        "A) 'To'xta, kim kelyapti' deb so'raydi",
        "B) 'To'xta, kim kelyapti?', keyin 'To'xta, orqaga!' — javob bermasa havoga ogohlantirish o'qi otish, bo'ysunmasa nishonga olish!",
        "C) Qurolning tugmasini bosadi va keyingi qadam bog'liq",
        "D) To'xtash buyrug'i berib, telefon orqali qo'ng'iroq qiladi"
      ],
      "correct": 1,
      "explanation": "Soqchi postida shubhali shaxsni to'xtatish uchun avval og'zaki buyruq beradi ('To'xta, kim kelyapti?'), javob olinmasa havoga ogohlantirish o'qi otadi, bo'ysunmasa nishonga olish huquqiga ega.",
      "mnemonic": "Nizomga ko'ra harakatlar ketma-ketligini eslab qoling."
    },
  {
      "q": "Harbiy (armiya) muhitida doim ommaviy holatda buyruq kelmasdan qanday tana holatida komandirni kutib olinadi yoki hurmat ko'rsatiladi?",
      "opts": [
        "A) O'tirgan holatda",
        "B) Tik turgan (Saf) holatida",
        "C) Faqat qo'l berib so'rashish orqali",
        "D) Erkin holatda"
      ],
      "correct": 1,
      "explanation": "Harbiy intizomga ko'ra, komandir kelganda yoki buyruq kutayotganda harbiy xizmatchi tik turgan, saf holatida (faraat) bo'lishi shart.",
      "mnemonic": "Harbiy xizmatchining saf holatini tasavvur qiling."
    },
  {
      "q": "Yopiq binoda komandirni ko'rganda (agar u yerda ko'p askarlar bo'lsa) nima deyiladi?",
      "opts": [
        "A) Hammaga jim turish",
        "B) Birinchi ko'rgan askar 'Diqqat' yoki 'O'rningdan tur, Diqqat' deya buyruq beradi",
        "C) Har kim o'zi salomlashadi",
        "D) Baqirib ismini aytish"
      ],
      "correct": 1,
      "explanation": "Kazarmani yoki binoga komandir kirganda, birinchi ko'rgan xizmatchi ovozi boricha \"Diqqat\" deb hammaga buyruq beradi va hamma o'rnidan turib qotadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Komandirning asosiy huquqi nimadan iborat?",
      "opts": [
        "A) Askar shaxsiy buyumlarini musodara qilish",
        "B) Bo'ysunuvchilarga buyruq berish va uning bajarilishini talab qilish",
        "C) Askarlarni maoshdan mahrum qilish",
        "D) Nizomni o'z xohishiga qarab o'zgartirish"
      ],
      "correct": 1,
      "explanation": "Komandir o'z bo'ysunuvchilariga buyruq berish, vazifalar yuklash hamda ularning ijrosini qat'iy talab qilish huquqi va majburiyatiga ega.",
    ...
    },
  {
      ...
      "correct": 1,
      "explanation": "Avtoritar - buyruqbozlik, demokratik - hamkorlik va tenglik.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Daryo floti oddiy askar va starshinalar tarkibida ikkita kichik yulduzchali pogon kimga tegishli?",
      "opts": [
        "A) Matros",
        "B) Michman",
        "C) Bosh michman",
      ...
      "correct": 1,
      "explanation": "Flotda ikkita vertikal emas, balki bir chiziqqa tekis joylashgan kichik yulduzchalar Michman pogonini ifodalaydi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Daryo flotida pagonda hech qanday yulduzchasiz, faqat ingichka gorizontal chiziqlar qaysi unvonga xos?",
      "opts": [
        "A) Matros",
        "B) Birinchi daraja va ikkinchi daraja starshinasi",
        "C) Kapitan",
        "D) Michman"
      ],
      "correct": 1,
      "explanation": "Kichik yulduzlarsiz faqat chiziqlardan iborat pogonlar asosan starshinalar (birinchi, ikkinchi daraja) uchun xos.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Daryo flotida 3 ta parallel yulduzchali kichik zobit tarkibidagi unvon nomini ayting.",
      "opts": [
        "A) Leytenant",
        "B) Katta leytenant",
        "C) Kapitan-leytenant",
      ...
      "correct": 2,
      "explanation": "Kichik zobit pogonidagi 3 tagacha yulduzchalar ketma-ketlikda xuddi quruqlikdagi kapitan kabi Kapitan-leytenant unvonini anglatadi.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Harbiy xizmatchilarni jismoniy va yuridik jazolash yuzasidan ularning xulqini tartibga soluvchi eng oliy ichki hujjat qaysi?",
      "opts": [
        "A) Faqat Konstitutsiya",
        "B) Qurolli Kuchlarning Intizomiy Nizomi",
        "C) Sud jinoyat kodeksi xolos",
        "D) Mahalla raisining tavsiyanomasi"
      ],
      "correct": 1,
      "explanation": "Umumharbiy nizomlar, xususan Intizomiy nizom - harbiylar orasidagi jazo va mukofot munosabatlarini belgilovchi maxsus yuridik Qonundir.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Askarlar ichki nizomga ko'ra o'z komandirlariga (boshliqlariga) murojaat qilayotganda gapni minan bilan boshlaydilar?",
      "opts": [
        "A) Oka deb murojat etadi",
        "B) Familiyasi bilan oddiy chaqiradi",
        "C) 'O'rtoq (Tovarish)' so'zi va qo'shib unvonini aytgan holda (Masalan: O'rtoq Leytenant)",
        "D) Ismiga qo'shib hurmat bilan aytadi"
      ],
      "correct": 2,
      "explanation": "Harbiy subordinatsiya muomalasida o'zidan katta va kichiklarga nisbatan yagona murojaat so'zi bu 'O'rtoq' so'zi hisoblanib, ketidan unvon yuritiladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy intizomning asosi nima?",
      "opts": [
        "A) Qo'rquv va jazo",
        "B) Qonunlar, harbiy nizomlar va komandirlar buyrug'iga ongli va so'zsiz bo'ysunish",
        "C) Faqat an'analar",
        "D) Do'stlik va kelishuv"
      ],
      "correct": 1,
      "explanation": "Harbiy intizom o'zining yuksak ongliligi va qonun oldidagi vatanparvarlik burchini chuqur tushunishga asoslanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy unvonlarni berish qanday amalga oshiriladi?",
      "opts": [
        "A) Askarning xohishiga qarab",
        "B) O'qishni bitirgan barchaga avtomatik ravishda",
        "C) Egallab turgan lavozimi, xizmat muddati, harbiy ma'lumoti va ijobiy xizmat xususiyatlariga ko'ra",
        "D) Faqat urush qatnashchilariga"
      ],
      "correct": 2,
      "explanation": "Harbiy unvon berish tegishli Nizom asosida, shtat lavozimi va muddatiga qat'iy rioya qilingan holda amalga oshiriladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy intizom nima?",
      "opts": [
        "Faqat buyruqlarni bajarish",
        "Barcha harbiy xizmatchilar tomonidan o'rnatilgan tartib va qoidalarga rioya qilinishi",
        "Jazo tizimi",
        "Sport bilan shug'ullanish"
      ],
      "correct": 1,
      "explanation": "Harbiy intizom - bu har bir askarning o'z mas'uliyatini tushunishi va qonun-qoidalarga so'zsiz bo'ysunishi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon hududida garnizon xizmatiga rahbarlikni kim amalga oshiradi?",
      "opts": [
        "A) Mudofaa vaziri",
        "B) Harbiy okrug qo‘mondoni",
        "C) Garnizon boshlig‘i",
        "D) Qorovul boshlig‘i"
      ],
      "correct": 2,
      "explanation": "Garnizon hududida garnizon xizmatiga rahbarlikni Garnizon boshlig‘i amalga oshiradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Gauptvaxtaga jo‘natish va qo‘riqlash (kuzatib borish) uchun transport vositasi kim tomonidan ajratiladi?",
      "opts": [
        "A) Viloyat mudofaa ishlari boshqarmasi yoki mahalliy hokimiyat organlari tomonidan.",
        "B) Garnizon harbiy komendanti yoki harbiy qism komandiri buyrug‘i bilan transport ajratiladi.",
        "C) Harbiy prokurorning maxsus qarori asosida ichki ishlar organlari tomonidan.",
        "D) Faqat intizomiy qismga yuborilayotganlar uchun maxsus temir yo‘l vagonlari ajratiladi."
      ],
      "correct": 1,
      "explanation": "Gauptvaxtaga jo‘natish va qo‘riqlash uchun transport vositasi garnizon harbiy komendanti yoki harbiy qism komandiri buyrug‘i bilan ajratiladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon xizmati tarkibiga kiruvchi 'naryad xizmati'ning maqsadi nima?",
      "opts": [
        "A) Ovqat tayyorlash",
        "B) Garnizon bo‘yicha tartibni va xizmatni tashkil etish",
        "C) Chet tillarini o‘rganish,",
        "D) dam olish tadbirlarini tashkil etish"
      ],
      "correct": 1,
      "explanation": "Garnizon xizmati tarkibiga kiruvchi 'naryad xizmati'ning maqsadi garnizon bo‘yicha tartibni va xizmatni tashkil etishdan iborat.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Gauptvaxtada saqlanayotganlar bilan o‘tkaziladigan mashg‘ulotlar davomiyligi kim tomonidan belgilanadi?",
      "opts": [
        "A) Mudofaa vaziri tomonidan tasdiqlangan yillik o‘quv rejasiga asosan.",
        "B) Kun tartibi doirasida garnizon harbiy komendanti tomonidan belgilanadi.",
        "C) Harbiy qism komandiri gauptvaxtaga kelib, mashg‘ulot grafigini tasdiqlaydi.",
        "D) Mashg‘ulotlar o‘tkazilmaydi, faqatgina ma’naviy-ma’rifiy soatlar bo‘lishi mumkin."
      ],
      "correct": 1,
      "explanation": "Mashg‘ulotlar davomiyligi kun tartibi doirasida garnizon harbiy komendanti tomonidan belgilanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Gauptvaxtada ovqat pishirish imkoniyati bo‘lmasa, ovqatlanish qanday tashkil etiladi?",
      "opts": [
        "A) Harbiy xizmatchilarning oila a’zolari tomonidan taom keltirilishiga ruxsat beriladi.",
        "B) Ovqatni gauptvaxtaga olib kelish tartibi garnizon harbiy komendanti tomonidan belgilanadi.",
        "C) Ularga faqat quruq payok (konserva mahsulotlari) va non berish bilan cheklaniladi.",
        "D) Eng yaqin fuqarolik oshxonalari bilan shartnoma tuzilib, taom sotib olinadi."
      ],
      "correct": 1,
      "explanation": "Ovqatni gauptvaxtaga olib kelish tartibi garnizon harbiy komendanti tomonidan belgilanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Gauptvaxtada saqlanayotganlarni yuvintirish (hammomga tushirish) davriyligi qanday?",
      "opts": [
        "A) Haftada bir marta garnizon harbiy komendanti belgilagan kun va vaqtda amalga oshiriladi.",
        "B) Har kuni ertalabki ko‘rikdan so‘ng barcha shaxsiy tarkib uchun majburiy hisoblanadi.",
        "C) Faqat muddatli harbiy xizmatchilar haftada ikki marta, ofitserlar esa har kuni yuvinadi.",
        "D) O‘n kunda bir marta, tibbiy ko‘rik natijalariga ko‘ra navbatma-navbat amalga oshiriladi."
      ],
      "correct": 0,
      "explanation": "Yuvintirish haftada bir marta garnizon harbiy komendanti belgilagan vaqtda amalga oshiriladi.",
      "mnemonic": "Tibbiy yordam - hayot saqlash."
    },
  {
      "q": "Agar gauptvaxtada bo‘sh joy bo‘lmasa, ushlangan harbiy xizmatchilar qayerda saqlanishi mumkin?",
      "opts": [
        "A) Harbiy qismning qurol-yarog‘ omborxonalarida yoki qorovulxona dahlizida.",
        "B) Garnizon harbiy komendaturasi alohida xonasida navbatchi nazoratida saqlanishi mumkin.",
        "C) Eng yaqin ichki ishlar boshqarmasining vaqtincha saqlash hibsxonasida.",
        "D) Ularning turar joyida (uyida) harbiy soqchi nazorati ostida qoldiriladi."
      ],
      "correct": 1,
      "explanation": "Bo‘sh joy bo‘lmagan taqdirda, garnizon harbiy komendaturasi alohida xonasida navbatchi nazoratida saqlanishi mumkin.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "\"Garnizon tadbirlari\"ga nimalar kiradi?",
      "opts": [
        "A) Faqatgina harbiy qism ichidagi ertalabki badantarbiya mashg‘ulotlari.",
        "B) Garnizon shaxsiy tarkibi ishtirokida o‘tkaziladigan paradlar, faxriy qorovul naryadlari va boshqa umumgarnizon marosimlari.",
        "C) Harbiy xizmatchilarning dam olish kunlaridagi shaxsiy safarlari.",
        "D) Harbiy qism oshxonasidagi oziq-ovqat ta’minoti tadbirlari."
      ],
      "correct": 1,
      "explanation": "Garnizon tadbirlariga paradlar, faxriy qorovul naryadlari va boshqa umumgarnizon marosimlari kiradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon boshlig‘i lavozimiga kim tayinlanadi?",
      "opts": [
        "A) Garnizondagi eng yosh va istiqbolli ofitserlardan biri.",
        "B) Shtat bo‘yicha ko‘zda tutilgan mansabdor shaxs, qoidaga ko‘ra, garnizon boshlig‘i vazifasini bajarayotgan birlashma (qo‘shilma, harbiy qism) komandiri.",
        "C) Harbiy okrug qo‘mondoni tomonidan tayinlangan maxsus fuqarolik shaxsi.",
        "D) Garnizondagi barcha harbiy qism komandirlari orasidan saylov yo‘li bilan aniqlangan ofitser."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘i vazifasini bajarayotgan birlashma (qo‘shilma, harbiy qism) komandiri tayinlanadi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Garnizon xizmati komendantining asosiy vazifasi bo'lib nima hisoblanadi?",
      "opts": [
        "A) Harbiylarning tibbiy ko'rigini tashkil qilish",
        "B) Garnizondagi barcha xizmatchilarning dars-mashg'ulotlarini o'tish",
        "C) Garnizondagi tartib-intizom, qorovul xizmati va harbiy xizmatchilarning ko'chadagi jamoat obro'sini nazorat qilish",
        "D) Faqatgina ofitserlarning uylarini ta'mirlash"
      ],
      "correct": 2,
      "explanation": "Komendant patrullar o'rnatish orqali gornizondagi qat'iy intizom va xizmatchilarning ko'chadagi xatti-harakatlarini nazorat qiladi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Qorovullik nizomiga ko'ra soqchiga (postda turganda) nimalar qat'iyan taqiqlanadi?",
      "opts": [
        "A) Faqatgina uxlash va telefon ishlatish",
        "B) O'tirish, uxlash, chekish, ovqatlanish, qurolni boshqasiga berish va postni ruxsatsiz tark etish",
        "C) Yengil ovqatlanish mumkin, ammo uxlash taqiqlanadi",
        "D) O'z postida baland ovozda gaplashmaslik shartida chekishga ruxsat bor"
      ],
      "correct": 1,
      "explanation": "Soqchi postning eng xavfsiz holatini ta'minlashi shart bo'lib, unga chalg'ituvchi har qanday harakat - shuningdek uxlash va ovqatlanish taqiqlangan.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy xizmatchiga beriladigan eng og'ir intizomiy jazo nima?",
      "opts": [
        "A) Yozma hayfsan",
        "B) Qamoqqa olish (Arrest)",
        "C) Navbatdan tashqari xizmat naryad",
        "D) Lavozim maoshidan ushlab qolish"
      ],
      "correct": 1,
      "explanation": "Intizomiy nizomga asosan qoidabuzarliklarga nisbatan qo'llaniladigan eng og'ir jazo xizmatchini gauptvaxtaga (arrestga) olinishidir.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Yuzma-yuz kelganda kichik unvondagilar yuqori unvondagilarga qanday tartibda ehtirom/harbiy salom ko'rsatishadi?",
      "opts": [
        "A) Salomini olish majburiy emas",
        "B) Dastlab yuqori darajadagi boshlaydi",
        "C) Kichik unvondagilar yoki lavozimdagilar har doim birinchi bo'lib harbiy salom beradi",
        "D) Ixtiyoriy, agar o'zi xohlasa"
      ],
      "correct": 2,
      "explanation": "Nizomga asosan harbiy salom har doim majburiy burch bo'lib, past unvondagilar katta unvondagilarga birinchi bo'lib qo'l ko'tarib salom beradi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Kontrakt bo‘yicha harbiy xizmatchi harbiy intizomni buzsa, unga nisbatan Intizomiy Nizomga ko'ra qanday jazolar ko‘riladi?",
      "opts": [
        "A) Faqat pul jarimasi va tanbeh",
        "B) Hayfsan, qattiq hayfsan, naryad, unvonni pasaytirish yoki xizmatdan bo'shatish",
        "C) Sud qilib o'lim jazosiga qadar",
        "D) Ota-onasini chaqirtirish va ogohlantirish"
      ],
      "correct": 1,
      "explanation": "Kontrakt bo'yicha xizmatchilar uchun maoshli va martabali tizim bo'lgani uchun, ularning xizmatiga munosib hayfsan, tushirish va bo'shatish choralari qo'llaniladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizon bo‘linmalariga va hududdagi harbiy tizimga jami qilib kim rahbarlik qiladi?",
      "opts": [
        "A) Harbiy qism komandiri",
        "B) Mudofaa vaziri",
        "C) Garnizon boshlig‘i",
        "D) Patrul boshlig'i"
      ],
      "correct": 2,
      "explanation": "Barcha joylashgan harbiy uzel va qismlarga bir hudud doirasida markaziy tuman rahbari sifatinda Garnizon boshlig'i javob beradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Intizomiy nizomga ko'ra, muddatli harbiy xizmatchilarga (oddiy askarlarga) navbatdagi rag'batlantirish tariqasida qancha muddatlik qo'shimcha ta'til berilishi mumkin?",
      "opts": [
        "A) 5 kunga qadar",
        "B) 10 kunga qadar",
        "C) Ta'til faqat ofitserlarga beriladi",
        "D) 15 kunga qadar"
      ],
      "correct": 0,
      "explanation": "Oddiy askarlar zo'r natija ko'rsatganda 5 kunga qadar qo'shimcha rag'bat ta'tilini olishga (uyga borib kelish) ruxsat beriladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy xizmatchilar orasida bo'ysundiruvchi va bo'ysunuvchi munosabatlari qaysi mezonlarga ko'ra belgilanadi?",
      "opts": [
        "A) Faqat harbiy unvoniga ko'ra",
        "B) Ham harbiy unvoniga, ham xizmat lavozimiga ko'ra",
        "C) Ularning yoshi kattaligiga ko'ra",
        "D) Xizmat stajiga ko'ra"
      ],
      "correct": 1,
      "explanation": "Ichki hizmat nizomiga asosan o'zaro subardinatsiya bu aynan - unvon va egallab turgan lavozimi (komandir/boshliq) hisoblanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy xizmatchi harbiy kiyimda bo'lmaganida (fuqarolik kiyimida) boshqa harbiylar bilan uchrashganda...",
      "opts": [
        "A) Salom berishga majbur emas",
        "B) Har qanday kiyimda bo'lishidan qat'i nazar, bosh kiyimsiz salom eshitadigan holatda ham hurmat saqlaydi",
        "C) Qo'lini ko'ksiga qo'yadi",
        "D) Faqat askarlar salom berishi shart"
      ],
      "correct": 1,
      "explanation": "Harbiy nizom: qayerda va qanday kiyimdaligidan qat'inazar ofitserlik/harbiylik viqori saqlanib, ehtirom qoidalari saqlanishi kerak.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Saf nizomida 'Qadami — MARSH' buyrug'i qanday qadam tashlash turini va daqiqasiga nechta qadamni bildiradi?",
      "opts": [
        "A) Saf qadami, daqiqasiga 110-120 qadam",
        "B) Oddiy qadam, daqiqasiga 80 qadam",
        "C) Yugurib, daqiqasiga 160 qadam",
        "D) Yurish qadami, daqiqasiga 60 qadam"
      ],
      "correct": 0,
      "explanation": "Saf yurishidagi qadam tezligi odatda minutiga 110-120 marta, qadam kengligi 70-80 sm uzunlikda bo'ladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy xizmatda xabar berishda yoki javob berayotganda qaysi so'zlar qat'iyan ishlatilishi Nizomda talab qilingan?",
      "opts": [
        "A) Iltimos va Rahmat",
        "B) 'Xo'p bo'ladi', 'Xuddi shunday', 'Tushunarli'",
        "C) 'Men qilaman', 'Tushundim'",
        "D) 'Ruxsat eting', 'Mayli'"
      ],
      "correct": 1,
      "explanation": "Harbiy tilda ruxsat etilgan so'zlar bor - Xo'p bo'ladi! Hech qanday 'tushundim', 'to'ppa to'g'ri' kabi so'zlar ishlatilmaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizon va qorovullik xizmatlari nizomida 'Post' deyish bilan nimaga urg'u beriladi?",
      "opts": [
        "A) Oddiy qamoqxona minorasiga",
        "B) Soqchi o'zining jangovar vazifasini bajarayotgan va unga ishonib topshirilgan barcha qo'riqlanadigan ob'ektlar, hududga",
        "C) Faqat chegara hududi qismiga",
        "D) Patrullar yig'iladigan kichik hududga"
      ],
      "correct": 1,
      "explanation": "Post — soqchiga himoya va mudofaa uchun tayinlangan hamda ixtiyoriga berilgan hamma mulk va atrofni o'z iniga qamraydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Saf nizomiga binoan, safda turish haqida berilgan buyruq necha qismdan iborat bo'ladi?",
      "opts": [
        "A) Tayyorgarlik va ijro",
        "B) Taniqlik va ijro",
        "C) Faqat ijro",
        "D) Tayyorgarlik, ogohlantirish, ijro"
      ],
      "correct": 0,
      "explanation": "Saf komandalari (buyruqlari) odatda ikkiga: masalan: Diqqat, O'ngga..... Buril! (Tayyorgarlik va Ijrochi holatlari).",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Umumharbiy nizomlarga kiritilgan so'nggi tahrirlar qayerda va kim tomonidan tasdiqlangan?",
      "opts": [
        "A) Mudofaa vaziri buyrug'i",
        "B) Qurolli Kuchlar Oliy Bosh qo'mondoni PF-23-son Farmoni bilan (2025)",
        "C) Oliy Majlis huquqiy qo'mitasidan",
        "D) Hokimiyat qarori bilan"
      ],
      "correct": 1,
      "explanation": "Nizomlar qonuniylik nuqtai-nazaridan davlat rahbarining ya'ni Prezidentning maxsus farmonlari (PF-23, 2025-yil) bilan tasdiqlanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Intizomiy razmida ko'rsatiladigan eng yuqori moddiy mukofot (rag'bat) yechimi qanday hisoblanadi?",
      "opts": [
        "A) Faqat faxriy yorliq bilan",
        "B) Lavozimni birdaniga ikki pog'ona oshirib yuborish",
        "C) Nomdor qimmatbaho sovg'alar (soat) berish yoki maosh oshirish",
        "D) Harbiy qismni tashlab ketish ruxsati"
      ],
      "correct": 2,
      "explanation": "Qimmatbaho nomdor (Komandir yozuvli soatlar) sovg'alar va minnatdorchilik yozuvi harbiyda asosiy moliyaviy-ruhiy rag'bat sanaladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Agar komandir xizmatchilarga g'ayri-odatiy (qonunga zid, aniq noqonuniy) buyruqni berganida askar qanday yo'l tutishi kerak?",
      "opts": [
        "A) Har qanday buyruq bajarilishi shart (muhokamasiz)",
        "B) Bajarib bo'lib so'ng ustidan arz qilishi kerak",
        "C) Noqonuniy ekanligini aytib va qonundan tashqari ish bo'lsa uni bajarmaslikka to'liq haqli ravishda bosh tortishi mumkin",
        "D) Qochishga urinishi kerak"
      ],
      "correct": 2,
      "explanation": "Garchi harbiy nizom buyruq muhokamasiz deyilsada, biroq bilib turib Qonunga xilof etilgan ochiq jinoiy amallarni qilishdan harbiy shaxs butkul huquqiy bosh tortishiga qonuniy haqqi bor.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Kechki 'otboy' dan (uyqu signalidan) to ertalabki 'podyom'gacha (turish) otryad yoki rota xonalarida qanday holat oqibatida qorovul chiroqlar qoldiriladi?",
      "opts": [
        "A) Barcha chiroq ochirib butkul tim qorong'ilik etiladi",
        "B) Faqat deraza tashqari chiroqlari yoqiladi",
        "C) Kichikroq va yoqimli chiroq-gece lampalari (dejurniy osvesheniya) doim yoniq turadi",
        "D) Farqi yo'q"
      ],
      "correct": 2,
      "explanation": "Nizom bo'yicha maxfiylik va extiyotkorlik yuzasidan navbatchilar kutish joyida va uzun karidorlarda dejurniy (xira yorituvchi chiroq) qoldiriladi, tungi uyquda.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Intizomiy nizom bo'yicha ofitserga tanbeh (hayfsan) berishning muddati har xil - agar asoratli qoidabuzarlik qilgan bo'lsa u oxir oqibat nima bo'ladi?",
      "opts": [
        "A) Qo'shimcha qorovullik qo'shib jazolanadi",
        "B) Ofitserlar asosan naryadga qolmaydi, aksincha komandirning maxsus Sudiga chaqirilib lavozim shkalasi/martabasi pastga olinadi",
        "C) Ixtiyoriy qamaladi",
        "D) Uni bir oy ichida kechiradi"
      ],
      "correct": 1,
      "explanation": "Ofitserlarning holatida askarlar kabi qizil burchak yo yuvish jazosi o'rniga, pul va martaba to'g'ridan to'g'ri kesiladi (martaba pastlatilishi).",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Saf ko'rigi faoliyati turlariga nimalar kiradi va komandir nimani tekshiradi?",
      "opts": [
        "A) Faqat askarlarning sog'lig'ini bilish uchun bo'ladi",
        "B) Harbiylarning ruhiyatiga qaraydi",
        "C) Ust-bosh kiyimini o'lchami, tashqi ko'rinishi, soqoli va qurollarning yaraqliligi/tozaligini tekshiradi",
        "D) Oila a'zolari tekshiruvi"
      ],
      "correct": 2,
      "explanation": "Saf ko'rigi ya'ni ustavoy smotr bu - harbiy xizmatchining qiyofasi shuningdek biriktirilgan asbobining ishlash jiyni nazoratdir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qism ichki ustaviga binoan oddiy askarlar kundalik necha soat bo'sh vaqt yo shahsiy ishlar u-n vaqtga ega?",
      "opts": [
        "A) Bo'sh vaqt nazarda tutilmagan",
        "B) Doimiy qat'iy rejimli mashq",
        "C) Kuniga 2 saotgacha (kechki taomdan keyin massviy yangilik uchun) dam olish xolati belgilanadi",
        "D) 5 soat ixtiyoriy"
      ],
      "correct": 2,
      "explanation": "Ustav talabida kunlik rasm-rusumlardan ortgan va kechki taomlanish davrida dam olish hamda yangilik ko'rish vaqti xususiy belgilanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Saf nizomida 'Diqqat' degan buyruqqa asosan harbiy xizmatchining tanasi va oyoqlari qanday o'rinda bo'lishi kerak?",
      "opts": [
        "A) Qo'llar orqada tutiladi",
        "B) Tovonlar birlashtiriladi oyoq uchlari bir oyoq kaftidek kenglikda ochilib, tizzalar to'g'ri, ko'krak biroz ko'tarilgan va qorin tortilgan holda",
        "C) Oyoqlar yelka kengligida, qullar cho'ntakda",
        "D) O'zini qanday qulay his qilsa shunday turadi"
      ],
      "correct": 1,
      "explanation": "Saf ustaviga ko'ra safda (Smirno/Diqqat xolatida) harbiy bo'y rostlaganda tana tekis daxlsiz qotib, poshnalar (tovon) jipslashadi va oyoq uchi tashqariga qaratiladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Ofitser va praporşçiklar (michman) ni jazolash bo'yicha qamoqqa muvofiq jazo - gauptvaxtaga olish tizimining farqi bormi?",
      "opts": [
        "A) Ularni hech qachon qamab bo'lmaydi",
        "B) Ular alohida izolyatorda maxsus xonada xizmat joyini taftishini kutadi",
        "C) Yo'q, oddiy askar bn bitta kamerada qattiq tutiladi",
        "D) Faqat askarlargagina mumkin"
      ],
      "correct": 1,
      "explanation": "Ichki hizmat va Intizomiydagi tartib qoidalarda xar bir ofitseri maqomi izolyatsiyada gumanistik tabilik ofistsler hujirasida qoldrilishdir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Safga turish buyruqlarida o'quvchilarga o'zida turgan safdan ajralib oldinga chiqishi qanday buyrug'lanadi?",
      "opts": [
        "A) 'Tashqariga yugur!'",
        "B) 'Oddiy askar Falonchiyev, safdan ....(faloncha) qadam chiq!'",
        "C) 'Askarlar yur!'",
        "D) 'Men oldimga kel!'"
      ],
      "correct": 1,
      "explanation": "Ustav buyrugi o'takesskin va qisqa: Ism familiya (Unvon xolda), safdan (falon yoxud 'Ikki') qadam chikish buyrug'idir - 'Ruxsat bering'- deb xarakatlanishi so'raladi.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Intizomiy bo'yicha eng kuchli va ko'rgazmali qism bayrog'i fonida rasmga tushish mukofoti asosan kimlarga nasib etadi?",
      "opts": [
        "A) Yosh komandirlargagina",
        "B) Safda(armyyaiad) favqulordta mardlik, eng og'ir qonli vazifa yoxud oylalarning eng fidoilor xodimlarga atlanib ushu surat unga va oilasiga unitilmas esdalik jonatiladi",
        "C) Oddiy dars qiiganilnarga",
        "D) Faqat askarlargaigna"
      ],
      "correct": 1,
      "explanation": "Askriy yohuf harbiy Qism(Polk) ning aslli janggoar byarogi tagida surstka tyuhshuv – davlat oldidi qaxxramomnik nischoni bo'ldirb u oiliagihai faxr msnktyig b'b ishtirok etsi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Harbylarning yuz jismonoy ko'rinishi(o'sigi) Saf qo'riqida(stoyvodai) kim tmondan diyarli taqiqlangan?",
      "opts": [
        "A) Soch va qalin soqol qo'shib olish taqiqlangan yuz toza bo'yishi va maxsus ofiserlar u.n ruxasstgina xolos",
        "B) Mo'ylov bo'masa bomasligia ustav qoida qiliogah",
        "C) Tishlaing optopqiqa oq qilib kursisiht",
        "D) Balntdd bo'yiiga usshirqiiga ruxasg yut"
      ],
      "correct": 0,
      "explanation": "Ustav xrabinng kiyifasda boshinig va byutunley soqil va muilovolaring gigenanik va asiryk qoyidaisis u.n muntazam tizza qirilisihtigniaa ta'qiklab uqutybiyk kltiraiydidirydidiyigyydqi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      ...
      "opts": [
        "A) Siyosiy qaydnoma",
        "B) Komandir buyrug'i va xizmat guvohnomasi",
        "C) Bilet va yo'llanma",
        "D) Shaxsiy ish yuritish hujjati (harbiy bileti va shaxsiy varaqasi)"
      ],
      "correct": 3,
    ...
    },
  {
      ...
      "opts": [
        "A) Soch va qalin soqol qo'yish taqiqlangan, yuz toza bo'lishi shart",
        "B) Mo'ylov bo'lmasa bo'lmasligiga ustav qoida qilmagan",
        "C) Tishlarning oppoq qilib tozalashiga e'tibor qaratiladi",
        "D) Baland bo'yliligiga ruxsat faqat yuqori unvonlilar beradi"
      ],
      "correct": 0,
    ...
    },
  {
      ...
      "opts": [
        "A) Ixtiyoriy ravishda hech narsa aytilmaydi",
        "B) Buyruq bajarilgandan so'ng boshliqqa xato haqida hisobot beriladi va xato tuzatiladi",
        "C) Qurol qo'ldan chiqariladi",
        "D) O'xshash buyruq qaytadan berilguniga qadar kutiladi"
      ],
      "correct": 1,
  ...
  {
      "q": "Bo'linmada naryadlar va qorovul tartib jadvallari devorlarda osig'lik turishining MAQSADI nima?",
      "opts": [
        "A) Faqat chiroyli dizayn uchun",
        "B) Har bir harbiy kelayetgan smenani avvaldan ko'rib tayyorgarligi va mas'uliyatini his etishi hamda ochiq shaffoflik uchun",
        "C) Joyni band qilish sabab",
        "D) Faqat askarlarni qo'rqitish uchun"
      ],
      "correct": 1,
      "explanation": "Bo'linmadagi hujjatlar, ayniqsa naryad doskasi hamma o'z burichini bilsin degan ustavoy maqsad (Ochiq Jadvallashtirish) uchun shaffof ko'rinib turadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qism (Rotada) shaxsiy gigenik tekshiruv o'tkazishda oyoq va tozalik vositalarini harbiylar saflanganda qaysilari aynan o'tkazilida komadir diqqarila qaraladi?",
      "opts": [
        "A) Atir sehpanligi xidiga",
        "B) Oq bo'yinliklar tozaligi(svejiy padshiva), oyoqlar gigenasi va oyoq kuilmlari, paypoq yohub patyankaninig ustadoy tozaligi shuningdaik dastro'mil borligi va soqolning diqqatliga qaralaridi",
        "C) Qancha pullari obrlgigi",
        "D) Oylaviy sumkalariniyitigi"
      ],
      "correct": 1,
      "explanation": "Askarning rotasi va qismidan kasalik terlamasi ciqmasdlig u-n gigenani ustavda padshiva(yoqa tozalig) va portyabka tozaidli maxsus sanitaery uslubila qattiq nazortatdqiidr.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Ushbu savolda ustav bo'yicha salomashish (tovoshli qo'l) tartibiga zid bo'lgan elementni toping:",
      "opts": [
        "A) Safda ketayotib bo'yinnii burib ko'rib qo'l kutarilishi shart qadan uzilmay",
        "B) Uyda o'itirib turilganda",
        "C) Qo'l bekordan bekor xar dpyim va xarqayerda ham kotarib yurgaliladi",
        "D) Qo'l barmoqlari birlashtirligan (yoylmagagn holatida) bosh kiyimigacha g'oz qotib u qadga etiladi va tushirilidai doimiy ravshsida"
      ],
      "correct": 3,
      "explanation": "Chetdagi g'arbona va asil ozbkikiston usulu yigilgan barmoq kiygim qisimiigag g'oz bilan tiylab urlihiidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Umumharbiy nizomlar qanday hujjat hisoblanadi?",
      "opts": [
        "A) Tavsiyaviy hujjat",
        "B) Harbiylarning kundalik hayoti, xizmat burchi va xulq-atvorini tartibga soluvchi asosiy qonuniy (huquqiy) hujjat",
        "C) Ixtiyoriy qoida",
        "D) Faqat askarlarga tegishli nizom"
      ],
      "correct": 1,
      "explanation": "Nizomlar armiya hayotining Asosiy Qonuni hisoblanib, hamma uchun bir xil majburiy xarakterga ega.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Qorovul xizmati qanday jangovar vazifa hisoblanadi?",
      "opts": [
        "A) Oddiy ish",
        "B) Qorovullik o'tash jangovar vazifani bajarish bilan barobar hisoblanadi va barcha qonunlar shunga mos keladi",
        "C) Jazolash",
        "D) Xo'jalik ishi"
      ],
      "correct": 1,
      "explanation": "Qorovul xizmatiga qo'yilgan askar ustav bo'yicha jang maydonidagi holat kabi mas'uliyat va qonuniy himoyaga o'tadi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Safda harbiy xizmatchilar orasidagi yonlama oraliqqa nima deyiladi?",
      "opts": [
        "A) Qator",
        "B) Interval",
        "C) Masofa (Distansiya)",
      ...
      "correct": 1,
      "explanation": "Saf nizomiga ko'ra, harbiylar yonma-yon turganda ularning yelkalari orasidagi ochiq joy interval deyiladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy salomni berishning asosiy qoidalari nimalardan iborat?",
      "opts": [
        "A) Istalgancha salom berish mumkin",
        "B) Harbiy salom qisqa, aniq harakat bilan beriladi: agar bosh kiyim bo'lsa, o'ng qo'l bosh kiyimga olib boriladi, yo'q bo'lsa boshni yengil egish va qaddini rostlash bilan bajariladi",
        "C) Qo'lni ko'krakka qo'yish",
        "D) Faqat tabassum qilish"
      ],
      "correct": 1,
      "explanation": "Harbiy ehtirom(salom) - bu harbiylarning bir-biriga ko'rsatadigan olijanob an'anasi va ustav qoidasidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Komandir(boshliq) o'z qo'l ostidagilarga nisbatan qo'pollik qilishi yoxud jismoniy jazo(urish) qo'llashi Nizomda ruxsat etilganmi?",
      "opts": [
        "A) Ha, u rahbar",
        "B) Qisman ruxsat berilgan",
        "C) Qat'iyan man qilinadi. Komandir talabchan bo'lishi shart, lekin shaxs qadr-qimmatini kamsitishga va qonunsiz zo'ravonlikka haqqi yo'q",
        "D) Faqat askarlarni urishi mumkin"
      ],
      "correct": 2,
      "explanation": "O'zbekiston harbiy qonunlariga ko'ra qo'l ko'tarish, haqorat qilish va noqonuniy jismoniy jazo berish jinoyat sanaladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Bitta joyda joylashgan (dislokatsiya bo'lgan) bir necha harbiy qismlar va muassasalar yig'indisi nima deyiladi?",
      "opts": [
        "A) Batalyon",
        "B) Garnizon",
        "C) Diviziya",
      ...
      "correct": 1,
      "explanation": "Biror shahar yoxud hududiy bo'linmada biriktirilgan bir necha xil turdagi harbiy qismlar va hospitallar umumiyligi Garnizon deyiladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Ofitser va askar ko'chada fuqarolarga qanday munosabatda bo'lishi ustavda majburiy etib qo'yilgan?",
      "opts": [
        "A) Qo'pol bo'lishi",
        "B) Yuqoridan qarashi",
        "C) Harbiy intizomga qat'iy rioya etib, jamoat tartibini buzmaslik, kattalarga hurmat va zaiflarga doim yordam berishi, harbiy nomga dog' tushirmasligi kerak",
        "D) Ularga e'tibor bermasligi"
      ],
      "correct": 2,
      "explanation": "Harbiy libos (forma) bu shunchaki kiyim emas. Uni kiygan inson davlatning himoyachisi sifatida har qanday vaziyatda aholiga xushmuomala bo'lishi talab qilinadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Intizomni buzib kameraga (gauptvaxtaga) olingan harbiylar u yerda telefon ishlatishi mumkinmi?",
      "opts": [
        "A) Ha, uydagilar bilan gaplashish uchun",
        "B) Yo'q, izolyatsiya xonasida u tashqi aloqadan, qulaylik va texnikalardan to'liq mahrum etiladi",
        "C) Ruxsat bilan o'yin o'ynashi mumkin",
        "D) Qat'iy belgilanmagan"
      ],
      "correct": 1,
      "explanation": "Gauptvaxta jazosida hech qanday gadjet bo'lmaydi. Faqat oddiy to'shak va Ustav kitobi beriladi xolos.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Komandirning buyrug'i qanday qilib ijro etilishi kerak?",
      "opts": [
        "A) E'tirozlar bilan",
        "B) Aniq, o'z vaqtida va so'zsiz (muhokamasiz) ijro etiladi",
        "C) Boshqalarga topshirish orqali",
        "D) Kechiktirib"
      ],
      "correct": 1,
      "explanation": "Harbiy sohada demokratiya yoki muhokama bo'lmaydi. Yakkaboshchilik va bo'ysunish - harbiy intizomning o'zagidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarni intizomiy nizom bo'yicha jazolash jarayonida agar ushbu shaxs mast holda bo'lsa qanday yo'l tutiladi?",
      "opts": [
        "A) Urmoq kerak",
        "B) Hozirning o'zida jazo elon qilinadi",
        "C) Mast harbiyga hech qachon shu vaqtning o'zida jazo elon qilinmaydi, u hushiga kelguniga qadar izolyatsiya qilinadi, so'ng ertasi kuni jazo beriladi",
        "D) Faqat shifokor jazolaydi"
      ],
      "correct": 2,
      "explanation": "Ustav qoidasiga ko'ra mast askar yoki afitser adekvat javob berolmagani uchun u bilan tortishilmaydi. U uxlab hushini yig'gandan so'ng qattiq tergov boshlanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Batalyon yoki Polkning Saf ko'rigi (Stroyevoy smotr) qachon va qanday maqsadda o'tkaziladi?",
      "opts": [
        "A) Qish va yoz mavsumi o'tishlarida, shuningdek shaxsiy tarkibning ta'minoti, qishki/yozgi kiyimlarining to'liqligi va tayyorgarligini tekshirish uchun komandir tomonidan belgilangan vaqtda o'tkaziladi",
        "B) Faqat jazolash u-n",
        "C) Ota-onalar majlisi u-n",
        "D) Har kuni ertalab"
      ],
      "correct": 0,
      "explanation": "Smotrlar armiyada qo'shinlarning butkul jangovar shayligini, har bitta askar sumkasidagi igna-ipigacha butun ekanligini yalpi nazorat qiladigan eng katta tekshiruvdir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Qaysi nizom harbiy qismlarda kun tartibi, xizmatni tashkil etish va harbiy xizmatchilarning kundalik faoliyatini belgilab beradi?",
      "opts": [
        "A) Intizom nizomi",
        "B) Ichki xizmat nizomi",
        "C) Saf nizomi",
        "D) Garnizon va qorovullik xizmatlari nizomi"
      ],
      "correct": 1,
      "explanation": "Ichki xizmat nizomi harbiy xizmatchilarning o'zaro munosabatlari, kun tartibi va kundalik faoliyat qoidalarini belgilaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy intizomning asosi nimaga tayanishi kerak?",
      "opts": [
        "A) Faqat jazolash qorquviga",
        "B) Har bir harbiy xizmatchining Vatan oldidagi burchini ongli ravishda tushunishiga",
        "C) Komandirning shaxsiy xohishiga",
        "D) Moddiy manfaatdorlikka"
      ],
      "correct": 1,
      "explanation": "Intizom nizomiga ko'ra, chinakam harbiy intizom fuqaroning o'z burchini ongli ravishda his qilishiga va vatanparvarlikka asoslanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Katta (boshliq) va kichiklar o'rtasidagi munosabatlarda qaysi qoida qat'iy hisoblanadi?",
      "opts": [
        "A) Boshliq buyrug'i muhokama qilinmasdan, so'zsiz va aniq bajarilishi shart",
        "B) Buyruqni xohlasa bajarishi mumkin",
        "C) Buyruq faqat yozma berilsagina bajariladi",
        "D) Kichik xizmatchi buyruqni boshqa boshliqqa shikoyat qilib, keyin bajaradi"
      ],
      "correct": 0,
      "explanation": "Ichki xizmat nizomi bo'yicha komandir (boshliq) buyrug'i qonundir, u so'zsiz, aniq va muddatida bajarilishi shart.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Qorovullik xizmatiga tayinlangan bo'linmaning maqsadi nima?",
      "opts": [
        "A) Sport bilan shug'ullanish",
        "B) Jangovar bayroqni, ob'yektlarni, omborlarni qo'riqlash va himoya qilish",
        "C) Boshqalarga ovqat pishirish",
        "D) Shaxsiy tarkibni tekshirish"
      ],
      "correct": 1,
      "explanation": "Garnizon va qorovullik xizmatlari nizomiga ko'ra, qorovul – jangovar bayroqni va muhim ob'yektlarni qo'riqlash hamda himoya qilish uchun tayinlanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Oddiy askar navbatchiligi qayerda o'taladi?",
      "opts": [
        "A) Qism shtabida",
        "B) Rotaning yotoqxonasida (kazarmada)",
        "C) Dala o'quv maydonida",
        "D) Markaziy qorovulxonada"
      ],
      "correct": 1,
      "explanation": "Ichki xizmat nizomiga muvofiq, rota bo'yicha navbatchi (yoki kunlikchi) kazarma (yotoqxona)da tartibni va xavfsizlikni ta'minlaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Intizom nizomi bo'yicha askarga qanday rag'batlantirish choralari qo'llanilishi mumkin?",
      "opts": [
        "A) Qismdan chetlatish",
        "B) Tashakkur e'lon qilish, faxriy yorliq, navbatdagi unvon, uydan xat",
        "C) Ish xaqini qirqish",
        "D) Qorovullikka tayinlash"
      ],
      "correct": 1,
      "explanation": "Rag'batlantirish choralari qatoriga saf oldida tashakkur e'lon qilish, faxriy yorliq, qo'shimcha ta'til, ko'krak nishonlari kabilar kiradi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Sog'lomlashtirish va jismoniy tarbiya soati harbiy qismlarda kunning qaysi qismida o'tkazilishi belgilangan?",
      "opts": [
        "A) Uyquga ketishdan oldin",
        "B) Uyg'onishdan so'ng, ertalabki badantarbiya vaqtida",
        "C) Tushlik paytida",
        "D) Kechasi soat 24:00 da"
      ],
      "correct": 1,
      "explanation": "Ichki xizmat nizomi kun tartibiga ko'ra, shaxsiy tarkib uyg'ongach, albatta ertalabki badantarbiya (zaryadka) bilan shug'ullanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Harbiy xizmatchilarga murojaat qilishda qanday atamalardan foydalanish kerak?",
      "opts": [
        "A) Do'stim, og'ayni",
        "B) O'rtoq so'zi va harbiy unvoni (masalan, o'rtoq serjant)",
        "C) Ism-sharifi bilan",
        "D) Laqab yoki familiya bilan"
      ],
      "correct": 1,
      "explanation": "Nizomga ko'ra barcha harbiy xizmatchilar bir-birlariga 'o'rtoq' so'ziga unvonni qo'shib murojaat qilishlari shart.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizon nima?",
      "opts": [
        "A) Qurol saqlanadigan xona",
        "B) Bitta aholi punkti (yoki tuman)da doimiy yoki vaqtincha joylashgan harbiy qismlar va muassasalar yig'indisi",
        "C) Dala oshxonasi",
        "D) Harbiylar shifoxonasi"
      ],
      "correct": 1,
      "explanation": "Garnizon – ma'lum bir hududda joylashgan, birgalikda himoya qilinadigan harbiy qismlar, bilim yurtlari va muassasalar majmuasidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Safda \"Tekislan!\" (Rovnyays!) komandasi berilganda nima qilinadi?",
      "opts": [
        "A) Hammaga ixtiyoriy harakatlanish ruxsat etiladi",
        "B) Hamma chap tomonga qaraydi",
        "C) Hamma o'ng tomonga (agar boshqacha buyruq bo'lmasa) boshini tez va ko'kragini kerib burib, o'zini tekislaydi",
        "D) Qurol ko'tariladi"
      ],
      "correct": 2,
      "explanation": "Saf nizomiga ko'ra, tekislanish odatda o'ng qanotdagi harbiy xizmatchiga qarab amalga oshiriladi, bunda hamma chiziq bo'ylab tekislanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Umumharbiy nizomlar faqat oddiy askarlar uchunmi yoki ofitserlar uchun hammi?",
      "opts": [
        "A) Faqat oddiy askarlar uchun",
        "B) Faqat kursantlar uchun",
        "C) Qurolli Kuchlarning barcha harbiy xizmatchilari (oddiy askardan tortib to generallargacha) uchun majburiydir",
        "D) Faqat zaxiradagilar uchun"
      ],
      "correct": 2,
      "explanation": "Umumharbiy nizomlar oliy huquqiy me'yor bo'lib, uning qoidalariga barcha darajadagi komandirlar va xizmatchilar birdek rioya qilishlari shart.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Ichki xizmat nizomi nimani tartibga soladi?",
      "opts": [
        "Harbiy parad tartibini",
        "Qurolli Kuchlar ichidagi kundalik hayot va xizmat tartibini",
        "Otish mashqlarini",
        "Chegarani qo'riqlash tartibini"
      ],
      "correct": 1,
      "explanation": "Ichki xizmat nizomi harbiy qismlar ichidagi kundalik turmush, tartib-intizom, navbatchilik va xizmat tartibini belgilaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Rotaning kundalik tartib-hayotiga kim bevosita mas'ul?",
      "opts": [
        "Polk qo'mondoni",
        "Rota qo'mondoni",
        "Batalyon qo'mondoni",
      ...
      "correct": 1,
      "explanation": "Rota qo'mondoni o'z bo'linmasi shaxsiy tarkibining kundalik hayoti, mashg'ulotlari va intizomiga bevosita mas'ul hisoblanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy intizom tushunchasi nimani anglatadi?",
      "opts": [
        "Faqat kiyim-kechak tartibi",
        "Buyruq va qonunlarga qat'iy rioya qilish, burchni vijdonan bajarish",
        "Faqat sport tartib-qoidalari",
        "Harbiy paradlarda ishtiroki"
      ],
      "correct": 1,
      "explanation": "Harbiy intizom — harbiy xizmatchilarning qonun, nizom va buyruqlarga qat'iy rioya qilishi, o'z burchini vijdonan bajarishi. 🧠 Eslab qoling: Intizom = Qonun + Majburiyat",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Intizomiy jazo qanday turlarga bo'linadi?",
      "opts": [
        "Og'zaki va yozma",
        "Ogohlantirish, haqorat, qamoq",
        "Ogohlantirish, intizomiy qamoq, unvondan tushirish",
        "Faqat jarima"
      ],
      "correct": 2,
      "explanation": "Intizomiy jazolar: ogohlantirish, qattiq ogohlantirish, navbatdan tashqari navoatga qo'yish, intizomiy qamoq, unvondan tushirish kabi turlarga bo'linadi.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Saf nizomining asosiy maqsadi nima?",
      "opts": [
        "Paradlarni tartibga solish",
        "Jangda harakatni belgilash",
        "Safda turish, harakat va bajarish tartibini belgilash",
        "Otish mashqlarini tartibga solish"
      ],
      "correct": 2,
      "explanation": "Saf nizomi harbiy xizmatchilarning safda turishi, qurilishi, harakati va qo'mondonlar buyruqlarini bajarish tartibini belgilaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Intizomiy nizom talablarini qo'llash Batalyon komandiri o'z qo'l ostidagi ofitserga nisbatan qanday intizomiy jazoni mustaqil ravishda qo'llash huquqiga EGA EMAS?",
      "opts": [
  ...
  {
      "q": "Saf nizomiga ko'ra tahlil Qo'mondon 'Rostlan' buyrug'ini berganida, askar yoki bo'linmaning to'g'ri va qat'iy harakati qanday bo'lishi kerak?",
      "opts": [
  ...
  {
      "q": "Ichki xizmat nizomi nima?",
      "opts": [
        "Paradlashish tartibi",
        "Qimmiy hayot va xizmat tartib-qoidalari",
        "Otish mashqlari",
        "Chegara himoyasi"
      ],
      "correct": 1,
      "explanation": "Ichki xizmat nizomi — harbiy qismlar ichidagi kundalik hayot, tartib-intizom qo'idalarini belgilaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Rota qo'mondoni kimga mas'ul?",
      "opts": [
        "Polk qo'mondoniga",
        "O'z rotasining tarbiyasi va xizmatiga",
        "Batalyon qo'mondoniga",
        "Navbatchi ofitsarga"
      ],
      "correct": 1,
      "explanation": "Rota qo'mondoni o'z rotasining kundalik hayoti, tarbiyasi va intizomiga bevosita mas'ul.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Intizomiy jazolar turlari?",
      "opts": [
        "2 tur",
        "5 tur",
        "3 tur",
      ...
      "correct": 1,
      "explanation": "Intizomiy jazolar: ogohlantirish, qattiq ogohlantirish, intizomiy qamoq, unvondan tushirish.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Saf nizomi nima?",
      "opts": [
        "Paradni tartibga solish",
        "Safda turish va harakat tartibini belgilash",
        "Jangda harakat",
        "Otish masqlari"
      ],
      "correct": 1,
      "explanation": "Saf nizomi — harbiy xizmatchilarning safda turishi, harakati va buyruqlarni bajarish tartibini belgilaydi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Soqchi post tabelida ko‘rsatilgan masofadan yaqinroqqa kimlarni qo‘ymasligi kerak?",
      "opts": [
        "Faqat harbiy kiyimda bo‘lmagan fuqarolarni va begona avtomashinalarni.",
        "O‘zi bo‘ysunadigan shaxslardan va ular kuzatuvida kelganlardan boshqa hech kimni.",
        "Faqat kechki vaqtda postga yaqinlashgan barcha shaxslarni masofadan to‘xtatishi lozim.",
        "Faqat qurollangan va shubhali ko‘ringan shaxslarni belgilangan masofada ushlab turishi kerak."
      ],
      "correct": 1,
      "explanation": "Nizomga ko'ra, soqchi faqat o'zi bo'ysunadigan shaxslarni (QB, QBYo, Tarqatuvchi) va ular bilan kelganlarni o'tkazishi shart.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Post (soqchi) soyaboni o‘lchamlari haqidagi ma’lumotni toping.",
      "opts": [
        "Soyabonning asosi kvadrat shaklda bo‘lib, tomonlari 1,4 metrga 1,4 metrni tashkil etadi.",
        "Soyabonning asosi 2 metrga 2 metr bo‘lib, balandligi 3 metrdan iborat bo‘lishi shart.",
        "Soyabonning asosi doira shaklida bo‘lib, uning diametri 1,5 metrga teng bo‘lishi lozim.",
        "Soyabonning asosi to‘rtburchak shaklda bo‘lib, uzunligi 2,5 metr va eni 1,4 metrni tashkil qiladi."
      ],
      "correct": 0,
      "explanation": "Nizom bo'yicha post soyabonining standart o'lchami 1.4x1.4 metrdir.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizonda tashkillashtiriladigan tadbirlar kompleksiga nimalar kiradi?",
      "opts": [
        "A) Tashkiliy, huquqiy, texnik va shu kabi tadbirlar",
        "B) sport musobaqalari, huquqiy tadbirlar",
        "C) konsert dasturlari huquqiy tadbirlar",
        "D) qishloq xo‘jaligi ishlari, sport musobaqalari"
      ],
      "correct": 0,
      "explanation": "Garnizon tadbirlariga tashkiliy, huquqiy, texnik va shu kabi tadbirlar kiradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon boshlig‘i uy-joy taqsimlashda qaysi tamoyillarga amal qilishi kerak?",
      "opts": [
        "A) Faqat eng yuqori unvonli ofitserlarni birinchi navbatda uy-joy bilan ta’minlash tartibini joriy qilish.",
        "B) Qonunchilik va ijtimoiy tenglik tamoyillariga amal qilgan holda, jamoatchilik fikrini inobatga olib, oshkoralikni ta’minlash.",
        "C) Uy-joy komissiyasi faoliyatini to‘xtatib turish va uylarni faqat o‘zining buyrug‘i bilan taqsimlash.",
        "D) Harbiy shaharchalardagi barcha bo‘sh uylarni harbiy xizmatchi bo‘lmagan fuqarolarga ijaraga berish."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘i uy-joy taqsimotida qonunchilik va ijtimoiy tenglik tamoyillariga amal qilishi shart.",
      "mnemonic": "Unvonlar - harbiy zinapoya."
    },
  {
      "q": "Garnizon va qorovul xizmati Nizomida ko‘rsatilmagan mansabdor shaxslarning huquq va majburiyatlari qanday belgilanadi?",
      "opts": [
        "A) O‘zaro kelishuv asosida",
        "B) Ularni tayinlashda tegishli buyruqlar bilan",
        "C) og‘zaki buyruq bilan",
        "D) Nizomga o‘zgartirish kiritish orqali"
      ],
      "correct": 1,
      "explanation": "Nizomda ko‘rsatilmagan mansabdor shaxslarning huquq va majburiyatlari ularni tayinlashda tegishli buyruqlar bilan belgilanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizon va qorovullik xizmatlari Nizomi necha bo‘lim va necha bobdan iborat?",
      "opts": [
        "A) 2 bo‘lim, 10 bob",
        "B) 3 bo‘lim, 12 bob",
        "C) 3 bo‘lim, 11 bob",
      ...
      "correct": 3,
      "explanation": "Garnizon va qorovullik xizmatlari Nizomi 4 bo‘lim, 15 bobdan iborat.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Sud tomonidan intizomiy qismga jo‘natish jazosiga hukm etilganlar gauptvaxtada qachongacha saqlanadi?",
      "opts": [
        "A) Hukm qonuniy kuchga kirgunga qadar gauptvaxtada ushlab turilishi mumkin.",
        "B) Sud hukmi e’lon qilingan vaqtdan boshlab 3 sutka davomida saqlanadi.",
        "C) Jazoni ijro etish muassasasiga boradigan poyezd kelguniga qadar.",
        "D) Harbiy qism komandiri ularni safdan chiqargunga qadar saqlab turiladi."
      ],
      "correct": 2,
      "explanation": "Sud tomonidan intizomiy qismga jo‘natish jazosiga hukm etilganlar jazoni ijro etish muassasasiga boradigan poyezd kelguniga qadar gauptvaxtada saqlanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy intizomni buzgani uchun ushlangan harbiy xizmatchi maksimal qancha vaqt ushlab turilishi mumkin?",
      "opts": [
        "A) Odatda 3 soatgacha, qonunchilikda nazarda tutilgan alohida hollarda 24 soatgacha.",
        "B) Intizom buzilgan vaqtdan boshlab kamida 10 sutkadan 15 sutkagacha bo‘lgan muddatda.",
        "C) Faqatgina komandirning yozma buyrug‘i bo‘lgunga qadar, lekin 48 soatdan oshmasligi kerak.",
        "D) Harbiy qismda umumiy yig‘ilish o‘tkazilib, qaram qaror qabul qilingunga qadar."
      ],
      "correct": 2,
      "explanation": "Harbiy intizomni buzgani uchun ushlangan harbiy xizmatchi komandirning yozma buyrug‘i bo‘lgunga qadar, lekin 48 soatdan oshmasligi kerak.",
      "mnemonic": "Sakkiz (8) soat uyqu - askar uchun baxt."
    },
  {
      "q": "Qaysi holatda harbiy xizmatchilar bir kishilik kameraga o‘tkazilishi mumkin?",
      "opts": [
        "A) Harbiy intizomni buzgan yoki ichki tartib-qoidalarni bajarmaganlik holatlari aniqlanganda.",
        "B) Faqat ofitserlar tarkibiga mansub bo‘lgan shaxslar har doim alohida kamerada saqlanadi.",
        "C) Harbiy xizmatni o‘tashdan bo‘yin tovlaganlar va oilaviy sharoiti og‘ir bo‘lganlar.",
        "D) Harbiy qism komandirining og‘zaki ko‘rsatmasi va shaxsiy tarkibning arizasiga binoan."
      ],
      "correct": 0,
      "explanation": "Harbiy intizomni buzgan yoki ichki tartib-qoidalarni bajarmaganlik holatlari aniqlanganda bir kishilik kameraga o‘tkazilishi mumkin.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": ". (6-modda) Safarbarlik chaqiruvi rezervidagi xizmatni tashkil etish va o‘tash tartibi qaysi huquqiy hujjat bilan belgilanadi?",
      "opts": [
        "A) O‘zbekiston Respublikasi Vazirlar Mahkamasining soha bo‘yicha qabul qilingan qarori bilan.",
        "B) O‘zbekiston Respublikasi Mudofaa vaziri tomonidan tasdiqlanadigan ichki idoraviy yo‘riqnoma bilan.",
        "C) O‘zbekiston Respublikasi Prezidenti tomonidan tasdiqlanadigan tegishli xizmatni o‘tash tartibi to‘g‘risidagi nizom bilan.",
        "D) Oliy Majlis palatalari tomonidan qabul qilingan va Mudofaa vazirligi bilan kelishilgan maxsus tartib bilan."
      ],
      "correct": 2,
      "explanation": "Ushbu xizmatni o‘tash tartibi O‘zbekiston Respublikasi Prezidenti tomonidan tasdiqlanadigan tegishli xizmatni o‘tash tartibi to‘g‘risidagi nizom bilan belgilanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "(29-modda) Harbiy xizmatchilarni xizmatdan bo‘shatish qaysi hujjatga muvofiq amalga oshiriladi?",
      "opts": [
        "A) O‘zbekiston Respublikasining Mehnat kodeksiga asosan",
        "B) O‘zbekiston Respublikasi fuqarolarining harbiy xizmatni o‘tash tartibi to‘g‘risidagi nizomga muvofiq",
        "C) Mudofaa vazirining ichki buyruqlari to‘plamiga asosan",
        "D) Mahalliy hokimliklarning harbiy safarbarlik qarorlariga muvofiq"
      ],
      "correct": 1,
      "explanation": "O‘zbekiston Respublikasi fuqarolarining harbiy xizmatni o‘tash tartibi to‘g‘risidagi nizomga muvofiq amalga oshiriladi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "28-modda) OHTMdan ikkinchi o‘quv yilida chetlashtirilgan kursantlar (intizomsizligi va sog‘lig‘idan tashqari) qanday imkoniyatga ega bo‘lishi mumkin?",
      "opts": [
        "A) Oddiy askarlar va serjantlar tarkibi lavozimlarida kontrakt bo‘yicha harbiy xizmatga kirish",
        "B) mudofaa ishlari bo‘limida ish yurituvchi bo‘lib ishlash",
        "C) Mudofaa vazirligi tizimida fuqaro xizmatchi sifatida faoliyat yuritish",
        "D) Ofitserlik kurslarida qayta o‘qish huquqini saqlab qolish"
      ],
      "correct": 0,
      "explanation": "Oddiy askarlar va serjantlar tarkibi lavozimlarida kontrakt bo‘yicha harbiy xizmatga kirish huquqiga ega bo‘lishi mumkin.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon boshlig‘ining asosiy majburiyatlaridan biri qaysi variantda to‘g‘ri ko‘rsatilgan?",
      "opts": [
        "A) Harbiy xizmatchilarning bo‘sh vaqtini mazmunli tashkil etish uchun madaniy tadbirlar rejasini tuzish.",
        "B) Har kuni garnizon xizmati masalalari bo‘yicha garnizondagi mansabdor shaxslar faoliyatiga rahbarlik qilish.",
        "C) Garnizon hududidagi barcha tijorat do‘konlarining faoliyatini nazorat qilish.",
        "D) Harbiy qismlarning jangovar tayyorgarlik mashg‘ulotlarini shaxsan o‘tkazish."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘i har kuni garnizon xizmati masalalari bo‘yicha garnizondagi mansabdor shaxslar faoliyatiga rahbarlik qiladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Ushbu Nizom talablarini buzganlik uchun harbiy xizmatchilar qanday javobgarlikka tortiladilar?",
      "opts": [
        "A) Faqatgina og‘zaki tanbeh berish bilan cheklaniladi.",
        "B) O‘zbekiston Respublikasi qonunchiligida belgilangan tartibda intizomiy, ma’muriy yoki jinoiy javobgarlikka tortiladilar.",
        "C) Faqatgina navbatdan tashqari naryadga qo‘yiladilar.",
        "D) Javobgarlik choralari harbiy qism komandiri tomonidan asossiz ravishda belgilanadi."
      ],
      "correct": 1,
      "explanation": "Nizom talablarini buzganlik uchun harbiy xizmatchilar qonunchilikda belgilangan tartibda intizomiy, ma’muriy yoki jinoiy javobgarlikka tortiladilar.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "\"Yong‘in nazorati\" tushunchasiga Nizomda qanday ta’rif berilgan?",
      "opts": [
        "A) Yong‘in sodir bo‘lganda uni o‘chirish uchun amalga oshiriladigan tezkor harakatlar.",
        "B) Yong‘in xavfsizligi talablariga rioya qilinishini tekshirish va tekshiruv natijalari bo‘yicha chora-tadbirlar ko‘rish maqsadida belgilangan tartibda amalga oshiriladigan faoliyat.",
        "C) Faqat yong‘in o‘chirish mashinalarining texnik holatini nazorat qilish jarayoni.",
        "D) Harbiy xizmatchilarga o‘t o‘chirish qoidalarini o‘rgatish bo‘yicha nazariy darslar."
      ],
      "correct": 1,
      "explanation": "Yong‘in xavfsizligi talablariga rioya qilinishini tekshirish va chora-tadbirlar ko‘rish maqsadida belgilangan faoliyat.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "\"Garnizon naryadi\" deganda nima tushuniladi?",
      "opts": [
        "A) Garnizon hududini tozalash uchun ajratilgan ishchi guruhi.",
        "B) Garnizonda yuksak harbiy intizomni saqlash, qorovullik va ichki xizmatni bajarish uchun ajratilgan harbiy xizmatchilar guruhi.",
        "C) Harbiy bayramlarda tantanali marsh o‘tish uchun tayyorlangan bo‘linma.",
        "D) Garnizon oshxonasida navbatchilik qiladigan oshpazlar jamoasi."
      ],
      "correct": 1,
      "explanation": "Garnizonda yuksak harbiy intizomni saqlash, qorovullik va ichki xizmatni bajarish uchun ajratilgan harbiy xizmatchilar guruhi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy shaharchada harbiy xizmatchilar va ularning oila a’zolari xavfsiz yashashini ta’minlash kimning javobgarligiga kiradi?",
      "opts": [
        "A) Mahalliy politsiya (ichki ishlar) idoralari boshliqlariga.",
        "B) Garnizon boshlig‘i.",
        "C) Harbiy shaharcha komendantining yordamchisiga.",
        "D) Uy-joy foydalanish bo‘limi (KEU) boshlig‘iga"
      ],
      "correct": 1,
      "explanation": "Bu majburiyat garnizon boshlig‘ining zimmasida bo‘lib, u barcha xizmatchilar va oila a’zolari uchun mas’uldir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Nizomda \"maxsus vositalar\" tushunchasiga nimalar kiritilgan?",
      "opts": [
        "A) Faqat o‘t ochar qurollar va ularning o‘q-dorilari, tungi ko‘rish moslamalari.",
        "B) Rezina tayoqlar, qo‘l kishanlar, elektroshokerlar, xizmat itlari, ko‘zdan yosh oqizuvchi moddalar, chalg‘itma ta’sir ko‘rsatuvchi nur-tovush moslamalari va zirhli mashinalar.",
        "C) Harbiy qismlarda ishlatiladigan aloqa vositalari va kompyuter texnologiyalari majmuasi.",
        "D) Shaxsiy tarkibning kundalik kiyim-kechaklari va dala sharoitidagi anjomlari."
      ],
      "correct": 1,
      "explanation": "Rezina tayoqlar, qo‘l kishanlar, elektroshokerlar, xizmat itlari, ko‘zdan yosh oqizuvchi moddalar va shu kabi moddalar.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizondagi harbiy qismlar qo‘shinlarini jalb etgan holda garnizon tadbirlarini o‘tkazish huquqi kimga tegishli?",
      "opts": [
        "A) Harbiy okrug shtab boshlig‘iga.",
        "B) Garnizon boshlig‘iga.",
        "C) Eng katta harbiy qism komandiriga.",
        "D) Harbiy prokurorga."
      ],
      "correct": 1,
      "explanation": "Garnizondagi harbiy qismlar qo‘shinlarini jalb etgan holda garnizon tadbirlarini o‘tkazish huquqi garnizon boshlig‘iga tegishli.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon chegaralari va garnizon mansabdor shaxslarining funktsional majburiyatlari qanday tartibda belgilanadi?",
      "opts": [
        "A) Faqatgina garnizon boshlig‘ining og‘zaki ko‘rsatmasi va buyrug‘i asosida.",
        "B) Vazirliklar rahbarlarining qo‘shma qarori bilan belgilanadi.",
        "C) Mo‘ljallanishi va tarkibidan kelib chiqib, harbiy qismlar (muassasalar) komandirlari bilan kelishilgan holda garnizon boshlig‘i tomonidan.",
        "D) Mahalliy davlat hokimiyati organlarining qarori bilan tasdiqlanadi."
      ],
      "correct": 2,
      "explanation": "Garnizon chegaralari va mansabdor shaxslarning majburiyatlari harbiy qismlar (muassasalar) komandirlari bilan kelishilgan holda garnizon boshlig‘i tomonidan belgilanadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon boshlig‘i har chorakda qanday tadbir o‘tkazishi shart?",
      "opts": [
        "A) Garnizon sport musobaqalarini tashkil etishi va g‘oliblarni taqdirlashi shart.",
        "B) Garnizondagi harbiy intizom, garnizon xizmatlari holatini tahlil qilishi hamda mas’ul shaxslar bilan birga yakun chiqarishi shart.",
        "C) Barcha harbiy xizmatchilarning oila a’zolari uchun ochiq eshiklar kuni o‘tkazishi shart.",
        "D) Harbiy texnikalarning mavsumiy ko‘rigini o‘tkazishi shart."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘i har chorakda garnizondagi harbiy intizom va xizmatlar holatini tahlil qilishi shart.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon mansabdor shaxslarari orasida yong‘in xavfsizligi bo‘yicha mutaxassis bo‘lmasa, bu vazifa kimga yuklanadi?",
      "opts": [
        "A) Eng yaqin yong‘in o‘chirish qismi boshlig‘iga.",
        "B) Nizomda belgilangan tartibda garnizon mansabdor shaxslaridan biriga yoki yong‘in xavfsizligi xizmati boshlig‘iga.",
        "C) Harbiy qismning eng tajribali serjantiga.",
        "D) Harbiy shaharchadagi fuqarolik xo‘jaligi xodimiga."
      ],
      "correct": 1,
      "explanation": "Bu vazifa Nizomda belgilangan tartibda garnizon mansabdor shaxslaridan biriga yoki yong‘in xavfsizligi xizmati boshlig‘iga yuklanadi.",
      "mnemonic": "Nizom - bu harbiy tartib asosi."
    },
  {
      "q": "Garnizon mansabdor shaxslari orasida yong‘in xavfsizligi bo‘yicha mutaxassis bo‘lmasa, bu vazifa kimga yuklanadi?",
      "opts": [
        "A) Eng yaqin yong‘in o‘chirish qismi boshlig‘iga.",
        "B) Nizomda belgilangan tartibda garnizon mansabdor shaxslaridan biriga yoki yong‘in xavfsizligi xizmati boshlig‘iga.",
        "C) Harbiy qismning eng tajribali serjantiga.",
  ...
  {
      "q": "\"Garnizon chegarasi\" deganda nima tushuniladi?",
      "opts": [
        "A) Harbiy qism atrofidagi baland devorlar va tikanli simlar.",
        "B) Garnizonning qo‘shni hududlarini ajratadigan hamda garnizon chegaralarini belgilab beruvchi shartli chiziq.",
        "C) Shahar va tuman o‘rtasidagi ma’muriy chegara hududi.",
        "D) Harbiy poligonning xavfli hududini ko‘rsatuvchi belgilar majmuasi."
      ],
      "correct": 1,
      "explanation": "Garnizon chegarasi deganda garnizonning qo‘shni hududlarini ajratuvchi va chegaralarini belgilab beruvchi shartli chiziq tushuniladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizonda jinoyatlar va ko‘ngilsiz hodisalarning oldini olish bo‘yicha chora-tadbirlarni kim belgilaydi?",
      "opts": [
        "A) Harbiy sud raisi.",
        "B) Garnizon boshlig‘i.",
        "C) Harbiy qism psixologi.",
        "D) Garnizon kutubxonachisi."
      ],
      "correct": 1,
      "explanation": "Garnizonda jinoyatlar va ko‘ngilsiz hodisalarning oldini olish bo‘yicha chora-tadbirlarni garnizon boshlig‘i belgilaydi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy okrug hududida garnizon xizmatiga rahbarlik kimning zimmasiga yuklatilgan?",
      "opts": [
        "A) O‘zbekiston Respublikasi Qurolli Kuchlari Bosh shtabi boshlig‘iga.",
        "B) Harbiy okrug qo‘shinlari qo‘mondoniga.",
        "C) Garnizon boshlig‘i etib tayinlangan eng yuqori martabali ofitserga.",
        "D) Viloyat harbiy-ma’muriy sektori rahbariga."
      ],
      "correct": 1,
      "explanation": "Harbiy okrug hududida garnizon xizmatiga rahbarlik harbiy okrug qo‘shinlari qo‘mondoniga yuklatilgan.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Garnizon boshlig‘i garnizon xizmatini tashkil etish masalalari bo‘yicha kimga bo‘ysunadi?",
      "opts": [
        "A) Faqatgina O‘zbekiston Respublikasi Prezidentiga.",
        "B) Harbiy okrug qo‘shinlari qo‘mondoniga.",
        "C) Harbiy shaharchaning barcha shaxsiy tarkibiga.",
        "D) Mahalliy viloyat hokimiga."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘i garnizon xizmatini tashkil etish masalalari bo‘yicha harbiy okrug qo‘shinlari qo‘mondoniga bo‘ysunadi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Harbiy shaharchada bir nechta harbiy qismlar joylashgan taqdirda \"harbiy shaharcha kattasi\" qanday tayinlanadi?",
      "opts": [
        "A) Barcha harbiy qism komandirlari navbatma-navbat ushbu vazifani bajaradilar.",
        "B) Garnizon boshlig‘ining buyrug‘i bilan harbiy qismlar komandirlaridan (boshliqlaridan) biri tayinlanadi.",
        "C) Eng katta maydonni egallagan harbiy qismning moddiy ta’minot boshlig‘i tayinlanadi.",
        "D) Shaharcha hududidagi eng yuqori harbiy unvonga ega bo‘lgan serjant tayinlanadi."
      ],
      "correct": 1,
      "explanation": "Garnizon boshlig‘ining buyrug‘i bilan harbiy qismlar komandirlaridan (boshliqlaridan) biri tayinlanadi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "O‘zbekiston Respublikasi hududida garnizon xizmatiga umumiy rahbarlikni kim amalga oshiradi?",
      "opts": [
        "A) Harbiy okrug qo‘shinlari qo‘mondoni shaxsan o‘zi.",
        "B) O‘zbekiston Respublikasi Mudofaa vaziri.",
        "C) Garnizon harbiy komendanti va uning o‘rinbosarlari.",
        "D) Vazirlar Mahkamasi huzuridagi maxsus komissiya raisi."
      ],
      "correct": 1,
      "explanation": "O‘zbekiston Respublikasi hududida garnizon xizmatiga umumiy rahbarlikni Mudofaa vaziri amalga oshiradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "CHQBT fani darsida o'qituvchi yigitlarga safda yurish, o'ngga-chapga burilish va qadam tashlashni amalda ko'rsatib bajartirmoqda. Ushbu dars qaysi turdagi darsga kiradi?",
      "opts": [
        "A) Ma'ruza darsi",
        "B) Amaliy mashg'ulot darsi",
        "C) Laboratoriya darsi",
        "D) Mustaqil ishlash darsi"
      ],
      "correct": 1,
      "explanation": "Saf tayyorgarligi yoki harakatlarni o'rganish to'g'ridan-to'g'ri maydonda qilinadigan amaliy mashg'ulot darsidir.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "O'qituvchining qaysi yondashuv turi o'quvchilarni so'zsiz bo'ysunishini, qat'iy intizomni va buyruqbozlikni anglatadi?",
      "opts": [
        "A) Gumanistik (insonparvar)",
        "B) Avtoritar (konservativ)",
        "C) Liberal",
        "D) Demokratik"
      ],
      "correct": 1,
      "explanation": "Avtoritar ta'lim - o'qituvchi yagona rahbar va boshqaruvchi ekanligini, qat'iy va cheklovlarga asoslangan ta'limni bildiradi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "CHQBT darsi o'qituvchisi formasida pala-partish, soqol olingan ammo xuddi e'tiborsiz kiyinib kirdi. Bu asosan nimaga salbiy ta'sir ko'rsatadi?",
      "opts": [
        "A) Hech qanday ta'sir qilmaydi",
        "B) O'qituvchining shaxsiy namunasiga va o'quvchilarni kasbga(harbiy intizomga) bo'lgan hurmatining yo'qolishiga",
        "C) Ota-onalarning kayfiyatiga",
        "D) O'quvchilar xursand bo'ladi"
      ],
      "correct": 1,
      "explanation": "O'qituvchi, ayniqsa harbiy ta'lim rahbari avvalo o'z tashqi ko'rinishi va aniq intizomi bilan yigitlarga tirik o'rnak va NAMUNA bo'lishi shart.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "CHQBT fani o'qituvchisida avtoritar qobiliyat qay darajada namoyon bo'lishi kerak?",
      "opts": [
        "A) Umuman bo'lmasligi kerak",
        "B) O'quvchilarga mutlaq erkinlik berilib bu qobiliyat o'chirilishi kerak",
        "C) Me'yorida - talabchanlik va harbiy intizomni ta'minlash uchun qat'iyat shaklida namoyon bo'lishi kerak",
        "D) Har doim va hamma narsada faqat shafqatsizlik qilib"
      ],
      "correct": 2,
      "explanation": "Pedagogikada avtoritar qobiliyat (talabchanlik va shaxsiy ta'sir kuchi) o'z me'yorida intizom va tartibni ta'minlashda juda asqotadi, biroq despotizmga aylanmasligi kerak.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Vaziyat: Yosh va iqtidorli o‘qituvchi maktabga yangi ishga keldi. U o‘quvchilar bilan do'stona munosabat o'rnatish uchun darsda ular bilan xuddi o'rtoqlardek chaqchaqlashib, intizomni biroz susaytirdi. Tez orada o'quvchilar uning darslarida shovqin soladigan va topshiriqlarni bajarmaydigan bo'lishdi. O'qituvchi qaysi pedagogik mezonda xatoga yo'l qo'ydi?",
      "opts": [
        "A) Pedagogik nazokat (takt)",
        "B) Avtoritar boshqaruv uslubi",
        "C) Masofa saqlash (subordinatsiya) va talabchanlik",
        "D) O'quvchilarni rag'batlantirish"
      ],
      "correct": 2,
      "explanation": "O'qituvchi va o'quvchi o'rtasida hurmatga asoslangan masofa (subordinatsiya) saqlanishi kerak. Do'stona munosabat o'rnatish qat'iylik va talabchanlikni inkor etmasligi lozim, aks holda intizom buziladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "CHQBT metodikasi va Pedagogik etika CHQBT o'qituvchisi amaliy mashg'ulot (saf tayyorgarligi) vaqtida o'quvchining harakatini qattiq tanqid qilib, boshqalar oldida izza qildi. O'qituvchi kasbiy etikaning qaysi eng muhim tamoyilini buzdi?",
      "opts": [
  ...
  {
      "q": "Pedagogik qobiliyatlarni ularning ta'rifi bilan moslashtiring.\n1. Akademik qobiliyat\n2. Avtoritar qobiliyat",
      "opts": [
        "1-bilimlarni o'quvchilarga sodda va tushunarli qilib yetkazish; 2-o'quvchilarga irodaviy ta'sir o'tkazish va intizomni saqlash",
        "1-fanni mukammal bilish; 2-o'quvchilar bilan hazillashish",
        "1-yangi texnologiyalardan foydalanish; 2-ota-onalar bilan ishlash",
        "1-psixologik tahlil qilish; 2-sport tadbirlarini tashkil etish"
      ],
      "correct": 0,
      "explanation": "Akademik qobiliyat — bu didaktik mahorat, avtoritar — bu o'quvchilarni boshqarish va intizomga o'rgatish.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Komandir vzvodga taktik sharoiti va relyefi sharoitlardan iborat 'Marshrut va Oriyentirlar' jadvlini qachon etkazadi?",
      "opts": [
        "A) Urush tugagandan song",
        "B) Yotilsh ovqatgacha",
        "C) Guruh dushman ustiga bevosita yetib borish (yoki joylashish) vazifasini marsh bilan boshla shundan oldin ko'rsatmali buyruqi shaklidda",
        "D) Kutilmagangda"
      ],
      "correct": 2,
      "explanation": "Guruh frontda yul oldin razvedka malummotlainga boy xaritada yo signald komandir xaqdan buyruq oladi va omon qoliw marshutini tushunib olgachi siljidi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Moslashtiring: O'qituvchining muloqot uslublari.\n1. Avtoritar\n2. Demokratik\n3. Liberal (Laissez-faire)\na) O'quvchilar erkin qo'yib yuborilgan, nazorat juda zaif\nb) Faqat buyruq va qat'iy talablar asosida, o'quvchi fikri inobatga olinmaydi\nc) O'zaro hamkorlik, fikrlar inobatga olinadi, qarorlar birgalikda qabul qilinadi",
      "opts": [
        "A) 1-b, 2-c, 3-a",
        "B) 1-c, 2-b, 3-a",
        "C) 1-b, 2-a, 3-c",
      ...
      "correct": 0,
      "explanation": "Avtoritar - qat'iy buyruqbozlik (b); Demokratik - o'zaro hamkorlik va hurmat (c); Liberal - o'z holiga tashlab qo'yish, talabchanlikning pastligi (a).",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Askarning okopi nima?",
      "opts": [
        "A) Mudofaa maqsadida jismoniy himoya ko'rsatish ustunligi uchun yer sharoitida qaziladigan eng oddiy jangovar xandaq shakli",
        "B) Askarlarning dam olish yotog'i",
        "C) Qurol saqlanadigan seyf",
        "D) Tanklar tushadigan quti"
      ],
      "correct": 0,
      "explanation": "Okop piyodalar taktikasi elementar qurilmalaridirki asosan dushman xujumiga bas kelib tirik qob va uni xam nobud etilish mudofaasida qaziladi.",
      "mnemonic": "Taktika - aqlli jang qilish san'ati."
    },
  {
      "q": "Jang maydonida yarador askar aslo tashlab ketilmasdan o'q maydoniodan evakyuasiya olib o'tishining qat'i qoiladari qo'mish qilingan?",
      "opts": [
        "A) Tashlab ketish xavsiz m.n.",
        "B) Urushni tugashni faqat ku'tishgsh",
        "C) Hozirgi uz shxsi qurollari bn o'k ostida yotib, emakllab (yelkag , belga yo qularida shpatga boylashbbib) snritar yoki dosti uni chetdagi maskirokka zona olib zudlk kimsaszik yul olshi qollanidi",
        "D) Tibbiyot ishichini yalinib charish."
      ],
      "correct": 2,
      "explanation": "Birinchi tibyob qudrat va taktik oqidan qutrishi uni qo'llarni bog'lab sekin yo o'rgmalbab xavsız plashkalafda tortib o't maydonigdan darhol chiqatlish burchi askraning sharafiddir.",
      "mnemonic": "Tibbiy yordam - hayot saqlash."
    },
  {
      "q": "Yugurish (Perebejka) uzinlgig va uni ocihq zoniada qanday taktikalanishi eng tugurishdi?",
      "opts": [
        "A) Uzik-yul davomili",
        "B) 2-3 sekundan oshmagan masiada qisqi qisqa chaqin(yugursh) blan darxrhol egililb sakrasha yer yuzi emaklab qo'lish - chuniki dushman o'q yoyligin(pulelmtot) qayta ulgurmaydign masofda xarkatini tolib ulishisidir uzishi.",
        "C) Butunlay otguncha",
        "D) Fqat biror urindr osliqb qo'shi"
      ],
      "correct": 1,
      "explanation": "Maxvsus isbot: Nishonga qarata olinishi, kegin qurvolni tetigig bosilgunciha 3 sekund otib dushman otadigan onda (Askari uzi chovda sakrp yotb qlishi maxsus) perebejkaning daxysiz urliydi.",
      "mnemonic": "Taktika - aqlli jang qilish san'ati."
    },
  {
      "q": "Agar piyoda askar oldindan ko'zlanmagan kutilmagan to'siq yoki dushman zarbiga dush kelsa Taktika unga qanday jismoniy vazifani topshiradi?",
      "opts": [
        "A) Ruxsat kutib jim yotib olish",
        "B) Dushman sezmay qolishi un osmoni qarab qochish",
        "C) Mudofaaga eng qulay bo'lgan tekkislik (o'rta balandli kovak yo xarobalar) ni Mustaqil zudlikla Egallash вa dushmanga ziddiy olovni boshlash",
        "D) O'z guruhini tashlab ketish"
      ],
      "correct": 2,
      "explanation": "Askar taktikada qo'g'irchoq emas! Keskin vaziyatlar (Vnezapnoe napaedenie) unga dushman manzilidan pana xududni zudlik bn egallab o't qaytarmasni burch laydi.",
      "mnemonic": "Har bir vazifa - mas'uliyat."
    },
  {
      "q": "Piyoda askarning jangi qanday joylarda eng qiyin hisoblanadi?",
      "opts": [
        "A) Ochiq dalada",
        "B) Katta avtomagistrallarda",
        "C) Aholi punktlarida (shahar ichida) va tog'li o'rmon sharoitida",
        "D) Daryo qirg'og'ida"
      ],
      "correct": 2,
      "explanation": "Shahar jangi va tog' jangi ko'rinmas pistirmalar, snayperlar va yaqin masofadagi to'qnashuvlar ko'pligi sababli eng qiyin taktik muhit sanaladi.",
      "mnemonic": "Kalit so'zga e'tibor bering va javobni vizuallashtiring."
    },
  {
      "q": "Jangda asirga tushganda yoki dushman hududida adashib qolganda askarning asosiy maqsadi nima bo'lishi kerak?",
      "opts": [
        "A) Dushman bilan hamkorlik qilish",
        "B) Iloji boricha ma'lumotni saqlab qolish, jonini asrash, qochish yo'llarini qidirish va o'z qo'shinlariga qo'shilish",
        "C) Qurolini tashlab uxlash",
        "D) Yig'lash"
      ],
      "correct": 1,
  ...
  {
      "q": "Rota yotoqxonasida (kazarmada) favqulodda holat (masalan, yong'in yoki dushman hujumi xavfi) yuz berdi. Ichki xizmat nizomi talablariga binoan, rota navbatchisi (dezhurniy) bunday o'ta og'ir va favqulodda vaziyat yuz berganda birinchi navbatda qanday qonuniy va taktik harakatni amalga oshirishi shart?",
      "opts": [
  ...
  {
      "q": "Rotada kun yakunlandi va kechki tekshiruv soati keldi. Rota navbatchisi shaxsiy tarkibni safga tizib. Ichki xizmat nizomi qoidalariga ko'ra, kechki tekshiruv o'tkazilishidan ko'zlangan asosiy maqsad nima va u qanday huquqiy tartibda amalga oshiriladi?",
      "opts": [
  ...
  {
      "q": "Kontrakt bo'yicha harbiy xizmatchi o'zining huquqlari yuqori lavozimdagi boshliq tomonidan buzilgan deb hisoblaganligi sababli u qonuniy tartibda shikoyat (ariza) topshirmoqchi. Ichki xizmat nizomi qoidalariga ko'ra, harbiy xizmatchilarga o'z boshliqlari ustidan shikoyat arizasini topshirish jarayonida qaysi harakat qonunan qat'iyan taqiqlangan?",
      "opts": [
  ...
  {
      "q": "Kontrakt bo'yicha harbiy xizmat o'tayotgan serjantga komandir buyrug'i bilan intizomiy jazo (masalan, hayfsan) berildi. Intizomiy nizom qoidalariga binoan, harbiy xizmatchiga berilgan intizomiy jazo sodir etilgan huquqbuzarlik aniqlangan kundan boshlab ko'pi bilan qancha muddat ichida e'lon qilinishi va kuchga kirishi shart?",
      "opts": [
  ...
  {
      "q": "Harbiy qismda aslahaxonalarga zarar yetkazganlikda gumonlanayotgan askarga intizomiy jazo berish rejalashtirilmoqda. Intizomiy nizom talablariga binoan, komandir huquqbuzarlik sodir etgan harbiy xizmatchiga jazo e'lon qilishidan oldin qaysi majburiy huquqiy protsedurani amalga oshirishi qonunan shart?",
      "opts": [
  ...
  {
      "q": "Askar buyruqni bajarmaganligi uchun unga nisbatan bitta buyruq bilan ham hayfsan, ham qism hududidan chiqishni taqiqlash jazosi, shuningdek, moddiy jarima bir vaqtda qo'llanildi. Intizomiy nizomning qat'iy qoidalariga ko'ra, ushbu jazo qo'llash jarayoni qonunan qanday baholanadi?",
      "opts": [
  ...
  {
      "q": "Kichik leytenant unvoniga ega bo'lgan vzvod komandiri o'ziga bo'ysunuvchi intizomli askarning ota-onasiga davlat nomidan rasmiy tashakkurnoma xati yubormoqchi. Intizomiy nizom qoidalariga ko'ra, boshliqlarning rag'batlantirish choralari qo'llash huquqi qonunan qanday cheklanadi?",
      "opts": [
  ...
  {
      "q": "Qorovul guruhi xizmat postlariga jo'nab ketishdan oldin qurollarni (avtomatlarni) o'qlash jarayonini bajarishi kerak. Nizom talablariga binoan, qorovul qurollari qayerda, kimning buyrug'i va bevosita nazorati ostida o'qlanadi hamda patron qachon stvol qutisiga (patronnikka) yuboriladi?",
      "opts": [
  ...
  {
      "q": "Soqchi qo'riqlayotgan harbiy ombor yoki ob'ekt hududida to'satdan yong'in kelib chiqdi. Garnizon va qorovullik xizmatlari nizomining qat'iy talablariga binoan, soqchi yong'inni ko'rgan birinchi soniyalarda qanday qonuniy va taktik harakatni zudlik bilan bajarishga qonunan mas'uldir?",
      "opts": [
  ...
  {
      "q": "Qorovul naryadi tarkibidagi askarlardan biri shaxsiy ehtiyojlari sababli yoki harbiy qismdagi do'stlari bilan ko'rishish maqsadida qorovulxona binosidan vaqtincha tashqariga chiqishni rejalashtirdi. Garnizon va qorovullik xizmatlari nizomining qat'iy talablariga binoan, qorovul tarkibiga kiruvchi askar, serjant va ofitserlarga qaysi holatda qorovulxonani va uning hududini tark etishga qonunan ruxsat beriladi?",
      "opts": [
  ...
  {
      "q": "Ertaga qorovul xizmatiga jo'nab ketishi kerak bo'lgan bo'linma askarlari bugun harbiy qismda maxsus tayyorgarlikdan o'tmoqdalar. Nizomning qat'iy talablariga muvofiq, askarlar qorovul xizmati naryadiga kirishishlaridan oldin, ular qaysi majburiy tayyorgarlik bosqichlaridan (amaliy va ruhiy ko'rikdan) o'tishlari qonunan shart qilib belgilangan?",
      "opts": [
  ...
  {
      "q": "CHQBT fani rahbari o'quvchilarga 'Ortga buril!' (Krugom) buyrug'ini berdi. Saf nizomida belgilangan harakat qoidalariga muvofiq, joyida burilishlar tananing qaysi qismlari (poshna va tana muvozanati) yordamida va qaysi elkadan (yo'nalishdan) burilish orqali qonunan to'g'ri bajarilishi shart?",
      "opts": [
  ...
  {
      "q": "Harbiy xizmatchi safdan tashqarida, bosh kiyimsiz (furajkasiz yoki beretsiz) kiyim formasida ketayotgan vaqtda qarshisidan yuqori unvondagi boshliq (komandir) chiqib qoldi. Saf nizomining yangi tahrirdagi talablariga binoan, bosh kiyimi bo'lmagan harbiy xizmatchi harakatda boshliqqa qanday to'g'ri qonuniy shaklda harbiycha salom berishi shart?",
      "opts": [
  ...
  {
      "q": "Vzvod oddiy qadam bilan marsh qilib ketayotgan vaqtda komandir 'Harakatda o'ngga — MARSH!' buyrug'ini berdi. Saf nizomining qat'iy talablariga binoan, harakatlanish vaqtida berilgan burilish buyrug'ining ijro qismi (\"MARSH!\") qaysi oyoq yerga qo'yilgan soniyada berilishi va burilish qaysi oyoq yordamida boshlanishi shart?",
      "opts": [
  ...
  {
      "q": "Joyida bir qatorli yoyma safda turgan vzvodni komandir ikki qatorli safga o'tkazmoqchi. Saf nizomida belgilangan normalarga ko'ra, bo'linmani ikki qatorga qayta tizishdan oldin majburiy ravishda qaysi hisob-kitob buyrug'i berilishi va xizmatchilar qanday harakat algoritmini bajarishlari shart?",
      "opts": [
  ...
  {
      "q": "Safda uzun stvolli qurol (avtomat) bilan turgan askar uzoq vaqt harakatlanish uchun qurol holatini o'zgartirishi kerak. Saf nizomi talablariga muvofiq, qurolni yelkadan belboqqa o'tkazish jarayoni necha taktdan (harakatdan) iborat va u qaysi qo'lning birlamchi harakati bilan qonunan boshlanishi shart?",
      "opts": [
  ...
  {
      "q": "Komandir safda turgan bo'linmaga 'Vzvod — TEKISLAN!' buyrug'ini berdi. Saf nizomining amaldagi qoidalariga ko'ra, ushbu buyruq berilganda saf boshidagi (o'ng qanotdagi) birinchi askardan tashqari barcha askarlar boshlarini qaysi tomonga burishlari va ko'krak qismini qanday holatda tutishlari qonunan shart?",
      "opts": [
  ...
  {
      "q": "Safda avtomati belbog'ida (o'ng yelkasida) osilgan holda turgan askarga komandir qurolni ko'krakka o'tkazish buyrug'ini berdi. Saf nizomining amaldagi qoidalariga binoan, qurolni belbog'dan ko'krakka o'tkazish harakati necha taktdan (bosqichdan) iborat va birinchi taktda o'ng qo'l avtomatning qaysi qismidan tutishi qonunan shart?",
      "opts": [
