...
const TARGET_DIR = nodePath.join(__dirname, 'fan', 'tarix');
const REPORT_FILE = nodePath.join(__dirname, 'fan', 'tarix_report.md');
...
async function main() {
  console.log("🔍 Scanning Tarix question blocks...");
  ...
  const reportMd = `# History Question Bank Audit Report
